...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,n){e[o]=n});return e}function CapCalCtrl(e,t,o,n){e.testMcs=function(){var t={method:"GET",url:"index.php?id=checkMod&modCode=CP3200"};o(t).then(function(t){e.testResults=t.data.ModuleCredit},function(e){console.log("error")})},e.modsTaken=function(){var t={method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+sessionStorage.netid};o(t).then(function(t){e.modsCount=t.data.Results.length,e.takenMods=[];for(var n=0,d=0;d<e.modsCount;d++)if(1==t.data.Results[d].Semester){e.takenMods[n]={};var s=t.data.Results[d].ModuleCode;e.$applyAsync(function(){console.log(s);var n={method:"GET",url:"index.php?id=checkMod&modCode="+s};o(n).then(function(o){e.credit={},null!=o.data.ModuleCredit?e.credit={ModuleCredit:o.data.ModuleCredit}:e.credit={ModuleCredit:10},console.log(e.credit),angular.extend(t.data.Results[d],e.credit),console.log(t.data.Results[d])},function(e){console.log("error")})}),e.takenMods[n]=t.data.Results[d],n++}},function(e){console.log("error")})}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0));var userName,studentId;angular.module("NUSAP").controller("CapCalCtrl",["$scope","$cookieStore","$http","$location",CapCalCtrl]);
