...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,s){e[o]=s});return e}function MasterCtrl(e,t,o,s,a,r,n,d){function i(){return o({method:"GET",url:"index.php?id=majorReq&maj=cs"})}function l(){return o({method:"GET",url:"index.php?id=profile&token="+token})}function u(e){return o({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function c(e,t,s){return o({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t+"&acadYear="+s})}function m(){return o({method:"GET",url:"index.php?id=modSearch"})}function g(t,o,s){c(t,o,s).then(function(o){if(""!==o.data){var s=[];e.preclusionList.push(t),void 0!==o.data.Preclusion&&(s=o.data.Preclusion.split(","),angular.forEach(s,function(t,o){if(-1==s[o].trim().indexOf("or")&&-1==s[o].trim().indexOf("OR")&&-1==s[o].trim().indexOf("and")&&-1==s[o].trim().indexOf("/"))s[o].trim().length<9&&e.preclusionList.push(s[o].trim());else if(-1!=s[o].trim().indexOf(" or ")){var a=[];a=s[o].trim().split(" or "),angular.forEach(a,function(t,o){if(-1==a[o].indexOf(" OR "))a[o].trim().length<9&&e.preclusionList.push(a[o].trim());else{var s=[];s=a[o].trim().split(" OR "),angular.forEach(s,function(t,o){s[o].trim().length<9&&e.preclusionList.push(s[o].trim())})}})}else if(-1!=s[o].trim().indexOf(" OR ")){var a=[];a=s[o].trim().split(" OR "),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}else if(-1!=s[o].trim().indexOf(" and ")){var a=[];a=s[o].trim().split(" and "),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}else if(-1!=s[o].trim().indexOf("/")){var a=[];a=s[o].trim().split("/"),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList))})}e.dashboardLoading=!1,e.searchLoading=!0,d(function(){e.dashboardLoading=!0},6e3);var p=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},i().then(function(e){console.log("testing json file"),console.log(e.data.matric2015.ULR)}),e.preclusionList=[],e.modList=[],e.plannedMods={selected:null,years:{"2015/2016":[],"2016/2017":[]}},e.notPrecluded=!0,e.prerequisiteNotFulfill=!0,m().then(function(t){sessionStorage.setItem("modsList",JSON.stringify(t.data));var o=JSON.parse(sessionStorage.getItem("modsList"));angular.forEach(o,function(t,s){e.modList.push({ModuleCode:o[s].ModuleCode,ModuleTitle:o[s].ModuleTitle,Semesters:o[s].Semesters})}),e.tempModList=e.modList}),e.isUpdated=!1,e.updateModList=function(t){var o=sessionStorage.getItem("oldText");if(null==o&&(o=""),e.searchLoading=!1,d(function(){e.searchLoading=!0},2e3),t=t.toUpperCase(),console.log("current Text : "+t),t.length<1)e.modList=e.tempModList,e.isUpdated=!0;else if(o.length<t.length){e.modList=[];for(var s=0;s<e.tempModList.length;s++)e.tempModList[s].ModuleCode.includes(t)&&e.modList.push({ModuleCode:e.tempModList[s].ModuleCode,ModuleTitle:e.tempModList[s].ModuleTitle,Semesters:e.tempModList[s].Semesters})}else{if(0==e.isUpdate){e.modList=[];for(var s=0;s<e.tempModList.length;s++)e.tempModList[s].ModuleCode.includes(t)&&e.modList.push({ModuleCode:e.tempModList[s].ModuleCode,ModuleTitle:e.tempModList[s].ModuleTitle,Semesters:e.tempModList[s].Semesters})}else{var a=e.modList;e.modList=[];for(var s=0;s<a.length;s++)a[s].ModuleCode.includes(t)&&e.modList.push({ModuleCode:a[s].ModuleCode,ModuleTitle:a[s].ModuleTitle,Semesters:a[s].Semesters})}sessionStorage.setItem("oldText",t)}},e.getProfile=function(){function t(e){e=parseInt(e);for(var t=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(0,4)),o=[],s=new Date,a=(s.getFullYear(),parseInt(s.getMonth())+1),r=e;t>=r;r++){var n=r+1;if(t>r){var d=r+"/"+n+"-1";o.push(d),d=r+"/"+n+"-2",o.push(d)}else if(7>a){var d=r+"/"+n+"-1";o.push(d),d=r+"/"+n+"-2",o.push(d)}else{var d=r+"/"+n+"-1";o.push(d)}}return o}l().then(function(o){console.log(o.data),e.username=o.data.Results[0].Name,sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",o.data.Results[0].UserID),sessionStorage.setItem("firstMajor",o.data.Results[0].FirstMajor),sessionStorage.setItem("secondMajor",o.data.Results[0].SecondMajor),sessionStorage.setItem("matricYear",o.data.Results[0].MatriculationYear),e.plannerSize=[],e.unlockSem=[];for(var s=4,a=o.data.Results[0].MatriculationYear,r=0;s>r;r++)e.plannerSize.push({candidatureYear:parseInt(a)+r+"/"+(parseInt(a)+r+1)});e.addYear=function(){if(s+=1,!(s>6)){var t={candidatureYear:parseInt(a)+s-1+"/"+(parseInt(a)+s)};e.plannerSize.push(t)}},u(o.data.Results[0].UserID).then(function(o){e.modsCount=o.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(o.data.Results)),e.specialMods=[],e.modsPerSem=[];var s=JSON.parse(sessionStorage.getItem("modsTaken"));JSON.parse(sessionStorage.getItem("modsTaken")).length;sessionStorage.setItem("userSem",JSON.stringify(t(JSON.parse(sessionStorage.getItem("matricYear"))))),console.log("test result : "+t(JSON.parse(sessionStorage.getItem("matricYear"))));var a=JSON.parse(sessionStorage.getItem("userSem"));angular.forEach(a,function(t,o){e.takenMods=[];var r=[];e.unlockSem.push(!1),angular.forEach(s,function(t,n){s[n].Semester==a[o].substring(10,11)&&s[n].AcadYear==a[o].substring(0,9)&&c(s[n].ModuleCode,s[n].Semester,s[n].AcadYear).then(function(t){var o=parseInt(sessionStorage.getItem("totalCreditTaken"));e.$applyAsync(function(){e.overallProgress=o/160*100+"%"}),""===t.data?(o+=4,sessionStorage.setItem("totalCreditTaken",o),r.unshift({ModuleCode:s[n].ModuleCode,ModuleTitle:s[n].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[n].AcadYear,Semester:s[n].Semester}),e.takenMods.push({ModuleCode:s[n].ModuleCode,ModuleTitle:s[n].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[n].AcadYear,Semester:s[n].Semester}),r[0].selectedModGrade=r[0].ModuleGrade[0],r[0].selectedModSuStatus=r[0].ModuleSuStatus[0],sessionStorage.setItem(s[n].ModuleCode,JSON.stringify({ModuleTitle:s[n].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:"-",AcadYear:s[n].AcadYear,Semester:s[n].Semester}))):(o+=parseInt(t.data.ModuleCredit),sessionStorage.setItem("totalCreditTaken",o),g(t.data.ModuleCode,s[n].Semester,s[n].AcadYear),r.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[n].AcadYear,Semester:s[n].Semester}),e.takenMods.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[n].AcadYear,Semester:s[n].Semester}),sessionStorage.setItem(t.data.ModuleCode,JSON.stringify({ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:"-",AcadYear:s[n].AcadYear,Semester:s[n].Semester})))})}),e.modsPerSem.push(r)})},function(e){console.log("error no mods found")})},function(t){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var t={method:"GET",url:"index.php?id=checkToken&token="+token};o(t).then(function(t){if($result=t.data.Success,0==$result)s.path("/login");else{var o=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",o),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},$(".popup").mouseover(function(){$(this).children(".moduleDetails").show()}).mouseout(function(){$(this).children(".moduleDetails").hide()}),$(document).ready(function(){var e;new Clipboard(".invite-link"),$.ajax({url:"https://www.googleapis.com/urlshortener/v1/url?key=AIzaSyBsoXP_gCh3umRVKqP5MOHfEHs1fxK84g0",type:"POST",data:JSON.stringify({longUrl:window.location.href}),contentType:"application/json",dataType:"json",success:function(t){e=t.id,$(".invite-link").attr("data-clipboard-text",e)}}),$(".invite-link").click(function(){var t=$("#invite-link");t.attr("value",e)})}),e.$watch(e.getWidth,function(o,s){o>=p?angular.isDefined(t.get("toggle"))?e.toggle=!!t.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,t.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0),history.replaceState({},null,"index.html"));var userName,studentId;sessionStorage.setItem("totalCreditTaken",0),angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q","$log","$timeout",MasterCtrl]);
