...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,s,o){e[s]=o});return e}function MasterCtrl(e,t,s,o,r,i,a,n){function d(){return s({method:"GET",url:"index.php?id=majorReq&maj=cs"})}function u(){return s({method:"GET",url:"index.php?id=profile&token="+token})}function l(e){return s({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function c(e,t,o){return s({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t+"&acadYear="+o})}function m(){return s({method:"GET",url:"index.php?id=modSearch"})}function g(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear")),o="matric"+s,r=t.data[o];e=r[0].totalModules[0].mods;var i=r[0].requiredMc;sessionStorage.setItem("coreRequiredMc",i),sessionStorage.setItem("coreModules",JSON.stringify(e))})}function S(){var e=[];d().then(function(t){for(var s=JSON.parse(sessionStorage.getItem("matricYear")),o="matric"+s,r=t.data[o],i=r[1].totalModules.length,a=0;i>a;a++)e.push(r[1].totalModules[a].mods);var n=r[1].requiredMc;sessionStorage.setItem("projectRequiredMc",n),sessionStorage.setItem("project8thMcModules",JSON.stringify(e))})}function p(){var e=[];d().then(function(t){for(var s=JSON.parse(sessionStorage.getItem("matricYear")),o="matric"+s,r=t.data[o],i=r[2].totalModules.length,a=0;i>a;a++)e.push(r[2].totalModules[a].mods);var n=r[2].requiredMc;sessionStorage.setItem("internshipRequiredMc",n),sessionStorage.setItem("internshipModules",JSON.stringify(e))})}function M(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear")),o="matric"+s,r=t.data[o];e=r[3].totalModules[0].mods;var i=r[3].requiredMc;sessionStorage.setItem("mathSciRequiredMc",i),sessionStorage.setItem("mathSciModules",JSON.stringify(e))})}function f(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear")),o="matric"+s,r=t.data[o];e=r[4].totalModules[0].mods;var i=r[4].requiredMc;sessionStorage.setItem("breathDepthRequiredMc",i),sessionStorage.setItem("breathDepthModules",JSON.stringify(e))})}function h(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear")),o="matric"+s,r=t.data[o];e=r[5].totalModules[0].mods;var i=r[5].requiredMc;sessionStorage.setItem("ULRRequiredMc",i),sessionStorage.setItem("ULRModules",JSON.stringify(e))})}function I(t,s,o){c(t,s,o).then(function(s){if(""!==s.data){var o=[];e.preclusionList.push(t),void 0!==s.data.Preclusion&&(o=s.data.Preclusion.split(","),angular.forEach(o,function(t,s){if(-1==o[s].trim().indexOf("or")&&-1==o[s].trim().indexOf("OR")&&-1==o[s].trim().indexOf("and")&&-1==o[s].trim().indexOf("/"))o[s].trim().length<9&&e.preclusionList.push(o[s].trim());else if(-1!=o[s].trim().indexOf(" or ")){var r=[];r=o[s].trim().split(" or "),angular.forEach(r,function(t,s){if(-1==r[s].indexOf(" OR "))r[s].trim().length<9&&e.preclusionList.push(r[s].trim());else{var o=[];o=r[s].trim().split(" OR "),angular.forEach(o,function(t,s){o[s].trim().length<9&&e.preclusionList.push(o[s].trim())})}})}else if(-1!=o[s].trim().indexOf(" OR ")){var r=[];r=o[s].trim().split(" OR "),angular.forEach(r,function(t,s){r[s].trim().length<9&&e.preclusionList.push(r[s].trim())})}else if(-1!=o[s].trim().indexOf(" and ")){var r=[];r=o[s].trim().split(" and "),angular.forEach(r,function(t,s){r[s].trim().length<9&&e.preclusionList.push(r[s].trim())})}else if(-1!=o[s].trim().indexOf("/")){var r=[];r=o[s].trim().split("/"),angular.forEach(r,function(t,s){r[s].trim().length<9&&e.preclusionList.push(r[s].trim())})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList));var r=JSON.parse(sessionStorage.getItem("coreModules")),i=parseInt(sessionStorage.getItem("coreRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=r.indexOf(e)&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("coreModules",JSON.stringify(r)),i-=4,0>=i&&(i=0),sessionStorage.setItem("coreRequiredMc",i))});var a=JSON.parse(sessionStorage.getItem("project8thMcModules")),n=parseInt(sessionStorage.getItem("projectRequiredMc"));angular.forEach(e.preclusionList,function(e,t){angular.forEach(a,function(t,s){-1!=t.indexOf(e)&&(t.splice(t.indexOf(e),1),sessionStorage.setItem("project8thMcModules",JSON.stringify(a)),n-=4,0>=n&&(n=0),sessionStorage.setItem("projectRequiredMc",n))})});var d=JSON.parse(sessionStorage.getItem("internshipModules")),u=parseInt(sessionStorage.getItem("internshipRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=d[0].indexOf(e)?(d[0].splice(d[0].indexOf(e),1),sessionStorage.setItem("internshipModules",JSON.stringify(d)),u-=12):-1!=d[1].indexOf(e)&&(d[1].splice(d[1].indexOf(e),1),sessionStorage.setItem("internshipModules",JSON.stringify(d)),u-=6),sessionStorage.setItem("internshipRequiredMc",u)});var l=JSON.parse(sessionStorage.getItem("mathSciModules")),c=parseInt(sessionStorage.getItem("mathSciRequiredMc")),m=JSON.parse(sessionStorage.getItem("modsTaken"));angular.forEach(e.preclusionList,function(e,t){-1!=l.indexOf(e)&&(l.splice(l.indexOf(e),1),sessionStorage.setItem("mathSciModules",JSON.stringify(l)),angular.forEach(m,function(t,s){t.ModuleCode===e&&(c-=4)}),sessionStorage.setItem("mathSciRequiredMc",c))}),-1==l.indexOf("MA1521")&&-1!=l.indexOf("MA1301")&&(l.splice(l.indexOf("MA1301"),1),sessionStorage.setItem("mathSciModules",JSON.stringify(l)),c-=4,sessionStorage.setItem("mathSciRequiredMc",c));var g=JSON.parse(sessionStorage.getItem("breathDepthModules")),S=parseInt(sessionStorage.getItem("breathDepthRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=g.indexOf(e)&&(g.splice(g.indexOf(e),1),sessionStorage.setItem("breathDepthModules",JSON.stringify(g)),S-=4,sessionStorage.setItem("breathDepthRequiredMc",S))});var p=JSON.parse(sessionStorage.getItem("ULRModules")),M=parseInt(sessionStorage.getItem("ULRRequiredMc")),f=JSON.parse(sessionStorage.getItem("modsTaken"));angular.forEach(e.preclusionList,function(e,t){-1!=p.indexOf(e)&&(p.splice(p.indexOf(e),1),sessionStorage.setItem("ULRModules",JSON.stringify(p)),angular.forEach(f,function(t,s){t.ModuleCode===e&&(M-=4)}),sessionStorage.setItem("ULRRequiredMc",M))}),e.$applyAsync(function(){e.currentULR=((20-M)/20*100).toFixed(0)+"%",e.currentCore=((120-(S+i+n+u+c))/120*100).toFixed(0)+"%"})})}e.dashboardLoading=!1,e.searchLoading=!0,n(function(){e.dashboardLoading=!0},6e3);var O=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},e.preclusionList=[],e.modList=[],e.plannedMods={selected:null,years:{"2015/2016":[],"2016/2017":[]}},e.notPrecluded=!0,e.prerequisiteNotFulfill=!0,m().then(function(t){sessionStorage.setItem("modsList",JSON.stringify(t.data));var s=JSON.parse(sessionStorage.getItem("modsList"));angular.forEach(s,function(t,o){e.modList.push({ModuleCode:s[o].ModuleCode,ModuleTitle:s[o].ModuleTitle,Semesters:s[o].Semesters})}),e.tempModList=e.modList}),e.isUpdated=!1,e.updateModList=function(t){var s=sessionStorage.getItem("oldText");if(null==s&&(s=""),e.searchLoading=!1,n(function(){e.searchLoading=!0},2e3),t=t.toUpperCase(),console.log("current Text : "+t),t.length<1)e.modList=e.tempModList,e.isUpdated=!0;else if(s.length<t.length){e.modList=[];for(var o=0;o<e.tempModList.length;o++)e.tempModList[o].ModuleCode.includes(t)&&e.modList.push({ModuleCode:e.tempModList[o].ModuleCode,ModuleTitle:e.tempModList[o].ModuleTitle,Semesters:e.tempModList[o].Semesters})}else{if(0==e.isUpdate){e.modList=[];for(var o=0;o<e.tempModList.length;o++)e.tempModList[o].ModuleCode.includes(t)&&e.modList.push({ModuleCode:e.tempModList[o].ModuleCode,ModuleTitle:e.tempModList[o].ModuleTitle,Semesters:e.tempModList[o].Semesters})}else{var r=e.modList;e.modList=[];for(var o=0;o<r.length;o++)r[o].ModuleCode.includes(t)&&e.modList.push({ModuleCode:r[o].ModuleCode,ModuleTitle:r[o].ModuleTitle,Semesters:r[o].Semesters})}sessionStorage.setItem("oldText",t)}},e.getProfile=function(){function t(e){e=parseInt(e);for(var t=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(0,4)),s=[],o=new Date,r=(o.getFullYear(),parseInt(o.getMonth())+1),i=e;t>=i;i++){var a=i+1;if(t>i){var n=i+"/"+a+"-1";s.push(n),n=i+"/"+a+"-2",s.push(n)}else if(7>r){var n=i+"/"+a+"-1";s.push(n),n=i+"/"+a+"-2",s.push(n)}else{var n=i+"/"+a+"-1";s.push(n)}}return s}u().then(function(s){console.log(s.data),e.username=s.data.Results[0].Name,g(),S(),p(),M(),f(),h(),sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",s.data.Results[0].UserID),sessionStorage.setItem("firstMajor",s.data.Results[0].FirstMajor),sessionStorage.setItem("secondMajor",s.data.Results[0].SecondMajor),sessionStorage.setItem("matricYear",s.data.Results[0].MatriculationYear),e.plannerSize=[],e.unlockSem=[];for(var o=4,r=s.data.Results[0].MatriculationYear,i=0;o>i;i++)e.plannerSize.push({candidatureYear:parseInt(r)+i+"/"+(parseInt(r)+i+1)});e.addYear=function(){if(o+=1,!(o>6)){var t={candidatureYear:parseInt(r)+o-1+"/"+(parseInt(r)+o)};e.plannerSize.push(t)}},l(s.data.Results[0].UserID).then(function(s){e.modsCount=s.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(s.data.Results)),e.specialMods=[],e.modsPerSem=[];var o=JSON.parse(sessionStorage.getItem("modsTaken"));JSON.parse(sessionStorage.getItem("modsTaken")).length;sessionStorage.setItem("userSem",JSON.stringify(t(JSON.parse(sessionStorage.getItem("matricYear"))))),console.log("test result : "+t(JSON.parse(sessionStorage.getItem("matricYear"))));var r=JSON.parse(sessionStorage.getItem("userSem"));angular.forEach(r,function(t,s){e.takenMods=[];var i=[];e.unlockSem.push(!1),angular.forEach(o,function(t,a){o[a].Semester==r[s].substring(10,11)&&o[a].AcadYear==r[s].substring(0,9)&&c(o[a].ModuleCode,o[a].Semester,o[a].AcadYear).then(function(t){var s=parseInt(sessionStorage.getItem("totalCreditTaken"));e.$applyAsync(function(){e.overallProgress=(s/160*100).toFixed(0)+"%"}),""===t.data?(s+=4,sessionStorage.setItem("totalCreditTaken",s),i.unshift({ModuleCode:o[a].ModuleCode,ModuleTitle:o[a].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:o[a].AcadYear,Semester:o[a].Semester}),e.takenMods.push({ModuleCode:o[a].ModuleCode,ModuleTitle:o[a].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:o[a].AcadYear,Semester:o[a].Semester}),i[0].selectedModGrade=i[0].ModuleGrade[0],i[0].selectedModSuStatus=i[0].ModuleSuStatus[0],sessionStorage.setItem(o[a].ModuleCode,JSON.stringify({ModuleTitle:o[a].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:"-",AcadYear:o[a].AcadYear,Semester:o[a].Semester}))):(s+=parseInt(t.data.ModuleCredit),sessionStorage.setItem("totalCreditTaken",s),I(t.data.ModuleCode,o[a].Semester,o[a].AcadYear),i.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:o[a].AcadYear,Semester:o[a].Semester}),e.takenMods.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:o[a].AcadYear,Semester:o[a].Semester}),sessionStorage.setItem(t.data.ModuleCode,JSON.stringify({ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:"-",AcadYear:o[a].AcadYear,Semester:o[a].Semester})))})}),e.modsPerSem.push(i)})},function(e){console.log("error no mods found")})},function(t){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var t={method:"GET",url:"index.php?id=checkToken&token="+token};s(t).then(function(t){if($result=t.data.Success,0==$result)o.path("/login");else{var s=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",s),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},$(".popup").mouseover(function(){$(this).children(".moduleDetails").show()}).mouseout(function(){$(this).children(".moduleDetails").hide()}),$(document).ready(function(){var e;new Clipboard(".invite-link"),$.ajax({url:"https://www.googleapis.com/urlshortener/v1/url?key=AIzaSyBsoXP_gCh3umRVKqP5MOHfEHs1fxK84g0",type:"POST",data:JSON.stringify({longUrl:window.location.href}),contentType:"application/json",dataType:"json",success:function(t){e=t.id,$(".invite-link").attr("data-clipboard-text",e)}}),$(".invite-link").click(function(){var t=$("#invite-link");t.attr("value",e)})}),e.$watch(e.getWidth,function(s,o){s>=O?angular.isDefined(t.get("toggle"))?e.toggle=!!t.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,t.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0),history.replaceState({},null,"index.html"));var userName,studentId;sessionStorage.setItem("totalCreditTaken",0),angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q","$log","$timeout",MasterCtrl]);
