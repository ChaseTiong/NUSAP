...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(o,t,n){e[t]=n});return e}function CapCalCtrl(e,o,t,n){e.testMcs=function(){var o={method:"GET",url:"index.php?id=checkMod&modCode=CP3200"};t(o).then(function(o){e.testResults=o.data.ModuleCredit},function(e){console.log("error")})},e.modsTaken=function(){var o={method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+sessionStorage.netid};t(o).then(function(o){e.modsCount=o.data.Results.length,e.takenMods=[];for(var n=0,s=0;s<e.modsCount;s++)if(2==o.data.Results[s].Semester){var a=o.data.Results[s].ModuleCode,d=o.data.Results[s].Semester;console.log(a);var l={method:"GET",url:"index.php?id=checkMod&modCode="+a+"&sem="+d};t(l).then(function(t){console.log("current count : "+n),e.takenMods[n]=t.data,""==t.data&&(e.takenMods[n]={ModuleCode:o.data.Results[s].ModuleCode,ModuleTitle:o.data.Results[s].ModuleTitle,ModuleCredit:4}),n+=1,console.log(e.takenMods[n])},function(e){console.log("error")})}},function(e){console.log("error")})}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0));var userName,studentId;angular.module("NUSAP").controller("CapCalCtrl",["$scope","$cookieStore","$http","$location",CapCalCtrl]);
