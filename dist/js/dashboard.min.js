...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,s){e[o]=s});return e}function MasterCtrl(e,t,o,s,a,n,d,r){function l(){return o({method:"GET",url:"index.php?id=majorReq&maj=cs"})}function i(){return o({method:"GET",url:"index.php?id=profile&token="+token})}function u(e){return o({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function m(e,t,s){return o({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t+"&acadYear="+s})}function c(){return o({method:"GET",url:"index.php?id=modSearch"})}function p(t,o,s){m(t,o,s).then(function(o){if(""!==o.data){var s=[];e.preclusionList.push(t),void 0!==o.data.Preclusion&&(s=o.data.Preclusion.split(","),angular.forEach(s,function(t,o){if(-1==s[o].trim().indexOf("or")&&-1==s[o].trim().indexOf("OR")&&-1==s[o].trim().indexOf("and")&&-1==s[o].trim().indexOf("/"))s[o].trim().length<9&&e.preclusionList.push(s[o].trim());else if(-1!=s[o].trim().indexOf(" or ")){var a=[];a=s[o].trim().split(" or "),angular.forEach(a,function(t,o){if(-1==a[o].indexOf(" OR "))a[o].trim().length<9&&e.preclusionList.push(a[o].trim());else{var s=[];s=a[o].trim().split(" OR "),angular.forEach(s,function(t,o){s[o].trim().length<9&&e.preclusionList.push(s[o].trim())})}})}else if(-1!=s[o].trim().indexOf(" OR ")){var a=[];a=s[o].trim().split(" OR "),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}else if(-1!=s[o].trim().indexOf(" and ")){var a=[];a=s[o].trim().split(" and "),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}else if(-1!=s[o].trim().indexOf("/")){var a=[];a=s[o].trim().split("/"),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList))})}e.dashboardLoading=!1,e.searchLoading=!0,r(function(){e.dashboardLoading=!0},3500);var g=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},l().then(function(e){console.log("testing json file"),console.log(e.data.matric2015.Core)}),e.preclusionList=[],e.modList=[],e.plannedMods={selected:null,years:{"2015/2016":[],"2016/2017":[]}},e.lists=[{label:"Men",allowedTypes:["man"],max:4,people:[{name:"Bob",type:"man"},{name:"Charlie",type:"man"},{name:"Dave",type:"man"}]},{label:"Women",allowedTypes:["woman"],max:4,people:[{name:"Alice",type:"woman"},{name:"Eve",type:"woman"},{name:"Peggy",type:"woman"}]},{label:"People",allowedTypes:["man","woman"],max:6,people:[{name:"Frank",type:"man"},{name:"Mallory",type:"woman"},{name:"Alex",type:"unknown"},{name:"Oscar",type:"man"},{name:"Wendy",type:"woman"}]}],c().then(function(t){sessionStorage.setItem("modsList",JSON.stringify(t.data));var o=JSON.parse(sessionStorage.getItem("modsList"));angular.forEach(o,function(t,s){e.modList.push({ModuleCode:o[s].ModuleCode,ModuleTitle:o[s].ModuleTitle,Semesters:o[s].Semesters})}),e.tempModList=e.modList}),e.isUpdated=!1,e.updateModList=function(t){var o=sessionStorage.getItem("oldText");if(null==o&&(o=""),e.searchLoading=!1,r(function(){e.searchLoading=!0},2e3),t=t.toUpperCase(),console.log("current Text : "+t),t.length<1)e.modList=e.tempModList,e.isUpdated=!0;else if(o.length<t.length){e.modList=[];for(var s=0;s<e.tempModList.length;s++)e.tempModList[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:e.tempModList[s].ModuleCode,ModuleTitle:e.tempModList[s].ModuleTitle,Semesters:e.tempModList[s].Semesters})}else{if(0==e.isUpdate){e.modList=[];for(var s=0;s<e.tempModList.length;s++)e.tempModList[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:e.tempModList[s].ModuleCode,ModuleTitle:e.tempModList[s].ModuleTitle,Semesters:e.tempModList[s].Semesters})}else{var a=e.modList;e.modList=[];for(var s=0;s<a.length;s++)a[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:a[s].ModuleCode,ModuleTitle:a[s].ModuleTitle,Semesters:a[s].Semesters})}sessionStorage.setItem("oldText",t)}},e.getProfile=function(){function t(e){var t=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(5)),o=[],s=new Date,a=(s.getFullYear(),s.getMonth());e=parseInt(e);for(var n=1,d=e;t>=d;d++){var r=d+1;r==t?9>a?(r=d+"/"+r+"-"+n,o.push(r),r=d+1,r=d+"/"+r+"-"+(n+1),o.push(r)):(r=d+"/"+r+"-"+n,o.push(r),r=d+1,r=d+"/"+r+"-"+(n+1),o.push(r),r=d+2,r=d+1+"/"+r+"-"+n,o.push(r)):t>r&&(r=d+"/"+r+"-"+n,o.push(r),r=d+1,r=d+"/"+r+"-"+(n+1),o.push(r))}return o}i().then(function(o){console.log(o.data),e.username=o.data.Results[0].Name,sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",o.data.Results[0].UserID),sessionStorage.setItem("firstMajor",o.data.Results[0].FirstMajor),sessionStorage.setItem("secondMajor",o.data.Results[0].SecondMajor),sessionStorage.setItem("matricYear",o.data.Results[0].MatriculationYear),e.plannerSize=[],e.unlockSem=[];for(var s=4,a=o.data.Results[0].MatriculationYear,n=0;s>n;n++)e.plannerSize.push({candidatureYear:parseInt(a)+n+"/"+(parseInt(a)+n+1)});e.addYear=function(){if(s+=1,!(s>6)){var t={candidatureYear:parseInt(a)+s-1+"/"+(parseInt(a)+s)};e.plannerSize.push(t)}},u(o.data.Results[0].UserID).then(function(o){e.modsCount=o.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(o.data.Results)),e.specialMods=[],e.modsPerSem=[];var s=JSON.parse(sessionStorage.getItem("modsTaken"));JSON.parse(sessionStorage.getItem("modsTaken")).length;sessionStorage.setItem("userSem",JSON.stringify(t(JSON.parse(sessionStorage.getItem("matricYear"))))),console.log("test result : "+t(JSON.parse(sessionStorage.getItem("matricYear"))));var a=JSON.parse(sessionStorage.getItem("userSem"));angular.forEach(a,function(t,o){e.takenMods=[];var n=[];e.unlockSem.push(!1),angular.forEach(s,function(t,d){s[d].Semester==a[o].substring(10,11)&&s[d].AcadYear==a[o].substring(0,9)&&m(s[d].ModuleCode,s[d].Semester,s[d].AcadYear).then(function(t){""===t.data?(n.unshift({ModuleCode:s[d].ModuleCode,ModuleTitle:s[d].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[d].AcadYear,Semester:s[d].Semester}),e.takenMods.push({ModuleCode:s[d].ModuleCode,ModuleTitle:s[d].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[d].AcadYear,Semester:s[d].Semester}),n[0].selectedModGrade=n[0].ModuleGrade[0],n[0].selectedModSuStatus=n[0].ModuleSuStatus[0],sessionStorage.setItem(s[d].ModuleCode,JSON.stringify({ModuleTitle:s[d].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:"-",AcadYear:s[d].AcadYear,Semester:s[d].Semester}))):(p(t.data.ModuleCode,s[d].Semester,s[d].AcadYear),n.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[d].AcadYear,Semester:s[d].Semester}),e.takenMods.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[d].AcadYear,Semester:s[d].Semester}),sessionStorage.setItem(t.data.ModuleCode,JSON.stringify({ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:"-",AcadYear:s[d].AcadYear,Semester:s[d].Semester})))})}),e.modsPerSem.push(n)})},function(e){console.log("error no mods found")})},function(t){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var t={method:"GET",url:"index.php?id=checkToken&token="+token};o(t).then(function(t){if($result=t.data.Success,0==$result)s.path("/login");else{var o=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",o),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(o,s){o>=g?angular.isDefined(t.get("toggle"))?e.toggle=!!t.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,t.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0),history.replaceState({},null,"index.html"));var userName,studentId;angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q","$log","$timeout",MasterCtrl]);

function BarCtrl(a,r,o,t){a.currentCore="5%",a.getBarChart=function(){var a=document.getElementById("canvas").getContext("2d");new Chart(a).HorizontalBar(barChartData,{responsive:!0,barShowStroke:!1})}}var randomScalingFactor=function(){return Math.round(100*Math.random())},barChartData={labels:["Core","ULR","UE"],datasets:[{fillColor:"#98FB98",strokeColor:"#00FF7F",highlightFill:"#00FF7F",highlightStroke:"#00FF7F",data:[randomScalingFactor(),randomScalingFactor(),randomScalingFactor()]},{fillColor:"#FA8072",strokeColor:"#FA8072",highlightFill:"#E58270",highlightStroke:"#FA8072",data:[randomScalingFactor(),randomScalingFactor(),randomScalingFactor()]}]};angular.module("NUSAP").controller("BarCtrl",["$scope","$cookieStore","$http","$location",BarCtrl]);
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,d){e[o]=d});return e}function CapCalCtrl(e,t,o,d,s,u){function l(e){e.style.maxHeight="0",r(1,function(){e.style.opacity="0"})}function r(e,t){var o=0,d=window.setInterval(function(){o++,o>=e&&(t(),window.clearInterval(d))},1e3)}function a(t,o,d){n(t,o,d).then(function(o){if(""!==o.data){var d=[];e.preclusionList.push(t),void 0!==o.data.Preclusion&&(d=o.data.Preclusion.split(","),angular.forEach(d,function(t,o){if(-1==d[o].trim().indexOf("or")&&-1==d[o].trim().indexOf("OR")&&-1==d[o].trim().indexOf("and")&&-1==d[o].trim().indexOf("/")&&-1==d[o].trim().indexOf("."))d[o].trim().length<9&&e.preclusionList.push(d[o].trim());else if(-1!=d[o].trim().indexOf(" or ")){var s=[];s=d[o].trim().split(" or "),angular.forEach(s,function(t,o){if(-1==s[o].indexOf(" OR "))s[o].trim().length<9&&e.preclusionList.push(s[o].trim());else{var d=[];d=s[o].trim().split(" OR "),angular.forEach(d,function(t,o){d[o].trim().length<9&&e.preclusionList.push(d[o].trim())})}})}else if(-1!=d[o].trim().indexOf(" OR ")){var s=[];s=d[o].trim().split(" OR "),angular.forEach(s,function(t,o){s[o].trim().length<9&&e.preclusionList.push(s[o].trim())})}else if(-1!=d[o].trim().indexOf(" and ")){var s=[];s=d[o].trim().split(" and "),angular.forEach(s,function(t,o){s[o].trim().length<9&&e.preclusionList.push(s[o].trim())})}else if(-1!=d[o].trim().indexOf("/")){var s=[];s=d[o].trim().split("/"),angular.forEach(s,function(t,o){s[o].trim().length<9&&e.preclusionList.push(s[o].trim())})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList))})}function i(t,o,d){n(t,o,d).then(function(o){if(""!==o.data){var d=[];e.preclusionList.splice(e.preclusionList.indexOf(t),1),void 0!==o.data.Preclusion&&(d=o.data.Preclusion.split(","),angular.forEach(d,function(t,o){if(-1==d[o].trim().indexOf("or")&&-1==d[o].trim().indexOf("OR")&&-1==d[o].trim().indexOf("and")&&-1==d[o].trim().indexOf("/"))d[o].trim().length<=9&&e.preclusionList.splice(e.preclusionList.indexOf(d[o].trim()),1);else if(-1!=d[o].trim().indexOf(" or ")){var s=[];s=d[o].trim().split(" or "),angular.forEach(s,function(t,o){if(-1==s[o].indexOf(" OR "))s[o].trim().length<=9&&e.preclusionList.splice(e.preclusionList.indexOf(s[o].trim()),1);else{var d=[];d=s[o].trim().split(" OR "),angular.forEach(d,function(t,o){d[o].trim().length<=9&&e.preclusionList.splice(e.preclusionList.indexOf(d[o].trim()),1)})}})}else if(-1!=d[o].trim().indexOf(" OR ")){var s=[];s=d[o].trim().split(" OR "),angular.forEach(s,function(t,o){s[o].trim().length<=9&&e.preclusionList.splice(e.preclusionList.indexOf(s[o].trim()),1)})}else if(-1!=d[o].trim().indexOf(" and ")){var s=[];s=d[o].trim().split(" and "),angular.forEach(s,function(t,o){s[o].trim().length<=9&&e.preclusionList.splice(e.preclusionList.indexOf(s[o].trim()),1)})}else if(-1!=d[o].trim().indexOf("/")){var s=[];s=d[o].trim().split("/"),angular.forEach(s,function(t,o){s[o].trim().length<=9&&e.preclusionList.splice(e.preclusionList.indexOf(s[o].trim()),1)})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList))})}function n(e,t,d){return o({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t+"&acadYear="+d})}function c(e){return"A+"===e||"A"===e?5:"A-"===e?4.5:"B+"===e?4:"B"===e?3.5:"B-"===e?3:"C+"===e?2.5:"C"===e?2:"D+"===e?1.5:"D"===e?1:0}var S=0,M=0;e.showLoading=!1,u(function(){e.showLoading=!0,sessionStorage.showLoading=!0},3500),e.slideUpAnimation=function(){console.log("animation start");var e=document.getElementById("sem1");l(e)},e.preclusionList=[],e.preclusionList=[];var m=JSON.parse(sessionStorage.getItem("modsTaken"));angular.forEach(m,function(e,t){a(m[t].ModuleCode.toUpperCase(),m[t].Semester,m[t].AcadYear)}),e.addSemester=function(){var t=[],o=JSON.parse(sessionStorage.getItem("userSem")).length;t=JSON.parse(sessionStorage.getItem("userSem"));var d=JSON.parse(sessionStorage.getItem("userSem"))[o-1],s=d.substring(10),u=parseInt(d.substring(0,4)),l=parseInt(d.substring(5,9)),r="",a=0;1==s?(a=2,r=u+"/"+l+"-"+a):(a=1,r=l+"/"+(l+1)+"-"+a),t.push(r),sessionStorage.setItem("userSem",JSON.stringify(t)),e.unlockSem[o]=!0,e.tempStorage=[];var a=(o+1)%2;0==a&&(a=2);for(var i=0;5>i;i++)e.tempStorage.push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:"-",selectedModGrade:"-",ModuleGrade:["-"],AcadYear:r.substring(0,9),Semester:a});e.modsPerSem.push(e.tempStorage)},e.addModule=function(){e.modsPerSem[0].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[0].substring(0,9),Semester:1})},e.addModule1=function(){e.modsPerSem[1].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[1].substring(0,9),Semester:1})},e.addModule2=function(){e.modsPerSem[2].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[2].substring(0,9),Semester:1})},e.addModule3=function(){e.modsPerSem[3].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[3].substring(0,9),Semester:1})},e.addModule4=function(){e.modsPerSem[4].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[4].substring(0,9),Semester:1})},e.addModule5=function(){e.modsPerSem[5].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[5].substring(0,9),Semester:1})},e.addModule6=function(){e.modsPerSem[6].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[6].substring(0,9),Semester:1})},e.addModule7=function(){e.modsPerSem[7].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[7].substring(0,9),Semester:1})},e.addModule8=function(){e.modsPerSem[8].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[8].substring(0,9),Semester:1})},e.addModule9=function(){e.modsPerSem[9].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[9].substring(0,9),Semester:1})},e.addModule10=function(){e.modsPerSem[10].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[10].substring(0,9),Semester:1})},e.addModule11=function(){e.modsPerSem[11].push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:JSON.parse(sessionStorage.getItem("userSem"))[11].substring(0,9),Semester:1})},s.onload=function(){e.capResult="0.00",S=0,M=0,sessionStorage.setItem("totalGradedPoint",0),sessionStorage.setItem("totalGradedMC",0)},e.$on("$stateChangeSuccess",function(){e.capResult="0.00",isNaN(parseInt(sessionStorage.getItem("totalGradedMC")))||isNaN(parseInt(sessionStorage.getItem("totalGradedPoint")))?(S=0,M=0):(S=parseInt(sessionStorage.getItem("totalGradedMC")),M=parseInt(sessionStorage.getItem("totalGradedPoint")),e.capResult=(M/S).toFixed(2),isNaN(e.capResult)&&(e.capResult="0.00"))}),e.searchMod=function(t,o){t.ModuleCode=t.ModuleCode.toUpperCase();var d=JSON.parse(sessionStorage.getItem("preclusionList"));n(t.ModuleCode.toUpperCase(),t.Semester,t.AcadYear).then(function(s){if(""!==s.data){var u=!1;angular.forEach(d,function(o,d){return t.ModuleCode===e.preclusionList[d]?(u=!0,console.log("found"),""):void 0}),0==u?(a(t.ModuleCode.toUpperCase(),t.Semester,t.AcadYear),sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList)),t.ModuleTitle=s.data.ModuleTitle,t.ModuleCredit=s.data.ModuleCredit,t.ModuleSuStatus=["No","Yes","Exempted","Waived"],t.ModuleGrade=["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],t.modFound=!0,t.selectedModGrade="-",t.selectedModSuStatus="No"):(t.ModuleTitle="Modules Taken/Precluded",t.ModuleCredit="-",t.ModuleSuStatus=["-"],t.ModuleGrade=["-"],t.modFound=!1,t.selectedModGrade="-",t.selectedModSuStatus="-"),console.log(s)}else t.ModuleSuStatus=["-"],t.ModuleGrade=["-"],t.selectedModGrade="-",t.selectedModSuStatus="-",t.ModuleCode.length>=7?t.ModuleTitle="Module Not Available":(""!==o.ModuleCredit&&null!==o.selectedModGrade&&"-"!==o.selectedModGrade&&(o.modFound===!0&&"No"===o.selectedModSuStatus&&void 0!==o.selectedModGrade&&(console.log(o.selectedModGrade),console.log("do calculation"),S-=parseInt(o.ModuleCredit),M-=c(o.selectedModGrade)*o.ModuleCredit,t.modFound=!1,e.capResult=(M/S).toFixed(2),isNaN(e.capResult)&&(e.capResult="0.00"),(isNaN(S)||isNaN(M))&&(S=0,M=0)),i(o.ModuleCode,o.Semester,o.AcadYear),u=!1),t.ModuleTitle=""),t.ModuleCredit="",t.selectedModGrade="-",t.selectedModSuStatus="-"})},e.changeValue=function(t,o){"Exempted"===t.selectedModSuStatus||"Waived"===t.selectedModSuStatus||"Yes"===t.selectedModSuStatus?(t.selectedModGrade="-",t.ModuleGrade=["-"]):t.ModuleGrade=["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],sessionStorage.setItem(t.ModuleCode,JSON.stringify({ModuleTitle:t.ModuleTitle,ModuleCredit:t.ModuleCredit,ModuleStatus:t.ModuleStatus,ModuleSuStatus:t.ModuleSuStatus,selectedModSuStatus:t.selectedModSuStatus,selectedModGrade:t.selectedModGrade,ModuleGrade:t.selectedModGrade,AcadYear:t.AcadYear,Semester:t.Semester})),e.$applyAsync(function(){"No"===o.selectedModSuStatus&&null!==o.selectedModGrade&&"-"!==o.selectedModGrade&&void 0!==o.selectedModGrade&&(S-=parseInt(o.ModuleCredit),M-=c(o.selectedModGrade)*o.ModuleCredit),"No"===t.selectedModSuStatus&&null!==t.selectedModGrade&&"-"!==t.selectedModGrade&&0!==c(t.selectedModGrade)&&(S+=parseInt(t.ModuleCredit),M+=c(t.selectedModGrade)*t.ModuleCredit),e.capResult=(M/S).toFixed(2),isNaN(e.capResult)&&(e.capResult="0.00"),(isNaN(S)||isNaN(M))&&(S=0,M=0),console.log("Total graded Mc : "+S),console.log("Total Graded point : "+M),sessionStorage.setItem("totalGradedMC",S),sessionStorage.setItem("totalGradedPoint",M)})}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0));var userName,studentId;angular.module("NUSAP").controller("CapCalCtrl",["$scope","$cookieStore","$http","$location","$window","$timeout",CapCalCtrl]);
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,s){e[o]=s});return e}function MasterCtrl(e,t,o,s,a,n,r,d){function i(){return o({method:"GET",url:"index.php?id=majorReq&maj=cs"})}function l(){return o({method:"GET",url:"index.php?id=profile&token="+token})}function u(e){return o({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function m(e,t,s){return o({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t+"&acadYear="+s})}function c(){return o({method:"GET",url:"index.php?id=modSearch"})}function p(t,o,s){m(t,o,s).then(function(o){if(""!==o.data){var s=[];e.preclusionList.push(t),void 0!==o.data.Preclusion&&(s=o.data.Preclusion.split(","),angular.forEach(s,function(t,o){if(-1==s[o].trim().indexOf("or")&&-1==s[o].trim().indexOf("OR")&&-1==s[o].trim().indexOf("and")&&-1==s[o].trim().indexOf("/"))s[o].trim().length<9&&e.preclusionList.push(s[o].trim());else if(-1!=s[o].trim().indexOf(" or ")){var a=[];a=s[o].trim().split(" or "),angular.forEach(a,function(t,o){if(-1==a[o].indexOf(" OR "))a[o].trim().length<9&&e.preclusionList.push(a[o].trim());else{var s=[];s=a[o].trim().split(" OR "),angular.forEach(s,function(t,o){s[o].trim().length<9&&e.preclusionList.push(s[o].trim())})}})}else if(-1!=s[o].trim().indexOf(" OR ")){var a=[];a=s[o].trim().split(" OR "),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}else if(-1!=s[o].trim().indexOf(" and ")){var a=[];a=s[o].trim().split(" and "),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}else if(-1!=s[o].trim().indexOf("/")){var a=[];a=s[o].trim().split("/"),angular.forEach(a,function(t,o){a[o].trim().length<9&&e.preclusionList.push(a[o].trim())})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList))})}e.dashboardLoading=!1,e.searchLoading=!0,d(function(){e.dashboardLoading=!0},3500);var g=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},i().then(function(e){console.log(e.data.matric2015.ULR)}),e.preclusionList=[],e.modList=[],e.lists=[{label:"Men",allowedTypes:["man"],max:4,people:[{name:"Bob",type:"man"},{name:"Charlie",type:"man"},{name:"Dave",type:"man"}]},{label:"Women",allowedTypes:["woman"],max:4,people:[{name:"Alice",type:"woman"},{name:"Eve",type:"woman"},{name:"Peggy",type:"woman"}]},{label:"People",allowedTypes:["man","woman"],max:6,people:[{name:"Frank",type:"man"},{name:"Mallory",type:"woman"},{name:"Alex",type:"unknown"},{name:"Oscar",type:"man"},{name:"Wendy",type:"woman"}]}],c().then(function(t){sessionStorage.setItem("modsList",JSON.stringify(t.data));var o=JSON.parse(sessionStorage.getItem("modsList"));angular.forEach(o,function(t,s){e.modList.push({ModuleCode:o[s].ModuleCode,ModuleTitle:o[s].ModuleTitle,Semesters:o[s].Semesters})}),e.tempModList=e.modList}),e.isUpdated=!1,e.updateModList=function(t){var o=sessionStorage.getItem("oldText");if(null==o&&(o=""),e.searchLoading=!1,d(function(){e.searchLoading=!0},2e3),t=t.toUpperCase(),console.log("current Text : "+t),t.length<1)e.modList=e.tempModList,e.isUpdated=!0;else if(o.length<t.length){e.modList=[];for(var s=0;s<e.tempModList.length;s++)e.tempModList[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:e.tempModList[s].ModuleCode,ModuleTitle:e.tempModList[s].ModuleTitle,Semesters:e.tempModList[s].Semesters})}else{if(0==e.isUpdate){e.modList=[];for(var s=0;s<e.tempModList.length;s++)e.tempModList[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:e.tempModList[s].ModuleCode,ModuleTitle:e.tempModList[s].ModuleTitle,Semesters:e.tempModList[s].Semesters})}else{var a=e.modList;e.modList=[];for(var s=0;s<a.length;s++)a[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:a[s].ModuleCode,ModuleTitle:a[s].ModuleTitle,Semesters:a[s].Semesters})}sessionStorage.setItem("oldText",t)}},e.getProfile=function(){function t(e){e=parseInt(e);for(var t=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(0,4)),o=[],s=new Date,a=(s.getFullYear(),parseInt(s.getMonth())+1),n=e;t>=n;n++){var r=n+1;if(t>n){var d=n+"/"+r+"-1";o.push(d),d=n+"/"+r+"-2",o.push(d)}else if(7>a){var d=n+"/"+r+"-1";o.push(d),d=n+"/"+r+"-2",o.push(d)}else{var d=n+"/"+r+"-1";o.push(d)}}return o}l().then(function(o){e.username=o.data.Results[0].Name,sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",o.data.Results[0].UserID),sessionStorage.setItem("firstMajor",o.data.Results[0].FirstMajor),sessionStorage.setItem("secondMajor",o.data.Results[0].SecondMajor),sessionStorage.setItem("matricYear",o.data.Results[0].MatriculationYear),e.plannerSize=[],e.unlockSem=[];for(var s=3,a=o.data.Results[0].MatriculationYear,n=0;s>n;n++)e.plannerSize.push({candidatureYear:parseInt(a)+n+"/"+(parseInt(a)+n+1),modsPerSem:5});e.addYear=function(){s+=1;var t={candidatureYear:parseInt(a)+s-1+"/"+(parseInt(a)+s),modsPerSem:5};e.plannerSize.push(t)},u(o.data.Results[0].UserID).then(function(o){e.modsCount=o.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(o.data.Results)),e.specialMods=[],e.modsPerSem=[];var s=JSON.parse(sessionStorage.getItem("modsTaken"));JSON.parse(sessionStorage.getItem("modsTaken")).length;sessionStorage.setItem("userSem",JSON.stringify(t(JSON.parse(sessionStorage.getItem("matricYear")))));var a=JSON.parse(sessionStorage.getItem("userSem"));angular.forEach(a,function(t,o){e.takenMods=[];var n=[];e.unlockSem.push(!1),angular.forEach(s,function(t,r){s[r].Semester==a[o].substring(10,11)&&s[r].AcadYear==a[o].substring(0,9)&&m(s[r].ModuleCode,s[r].Semester,s[r].AcadYear).then(function(t){var o=parseInt(sessionStorage.getItem("totalCreditTaken"));e.$applyAsync(function(){e.overallProgress=o/160*100+"%"}),""===t.data?(o+=4,sessionStorage.setItem("totalCreditTaken",o),n.unshift({ModuleCode:s[r].ModuleCode,ModuleTitle:s[r].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[r].AcadYear,Semester:s[r].Semester}),e.takenMods.push({ModuleCode:s[r].ModuleCode,ModuleTitle:s[r].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[r].AcadYear,Semester:s[r].Semester}),n[0].selectedModGrade=n[0].ModuleGrade[0],n[0].selectedModSuStatus=n[0].ModuleSuStatus[0],sessionStorage.setItem(s[r].ModuleCode,JSON.stringify({ModuleTitle:s[r].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:"-",AcadYear:s[r].AcadYear,Semester:s[r].Semester}))):(o+=parseInt(t.data.ModuleCredit),sessionStorage.setItem("totalCreditTaken",o),p(t.data.ModuleCode,s[r].Semester,s[r].AcadYear),n.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[r].AcadYear,Semester:s[r].Semester}),e.takenMods.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[r].AcadYear,Semester:s[r].Semester}),sessionStorage.setItem(t.data.ModuleCode,JSON.stringify({ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:"-",AcadYear:s[r].AcadYear,Semester:s[r].Semester})))})}),e.modsPerSem.push(n)})},function(e){console.log("error no mods found")})},function(t){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var t={method:"GET",url:"index.php?id=checkToken&token="+token};o(t).then(function(t){if($result=t.data.Success,0==$result)s.path("/login");else{var o=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",o),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(o,s){o>=g?angular.isDefined(t.get("toggle"))?e.toggle=!!t.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,t.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0),history.replaceState({},null,"index.html"));var userName,studentId;sessionStorage.setItem("totalCreditTaken",0),angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q","$log","$timeout",MasterCtrl]);
>>>>>>> 99feed793928dff1d4d2b48d4b0ea590d2cb7e5a
