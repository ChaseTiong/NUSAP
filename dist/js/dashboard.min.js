...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,n){e[o]=n});return e}function CapCalCtrl(e,t,o,n){}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0));var userName,studentId;angular.module("NUSAP").controller("CapCalCtrl",["$scope","$cookieStore","$http","$location",CapCalCtrl]);
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(o,t,n){e[t]=n});return e}function MasterCtrl(e,o,t,n,s,a){function l(){return t({method:"GET",url:"index.php?id=profile&token="+token})}function r(e){return t({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function d(e,o){return t({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+o})}var i=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},e.getProfile=function(){l().then(function(o){e.username=o.data.Results[0].Name,sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",o.data.Results[0].UserID),sessionStorage.setItem("matricYear",o.data.Results[0].MatriculationYear),r(o.data.Results[0].UserID).then(function(o){e.modsCount=o.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(o.data.Results)),console.log(JSON.parse(sessionStorage.getItem("modsTaken"))),e.takenMods=[],e.specialMods=[];var t=JSON.parse(sessionStorage.getItem("modsTaken")),n=JSON.parse(sessionStorage.getItem("modsTaken")).length;console.log("total mods : "+n),angular.forEach(t,function(o,n){1==t[n].Semester&&d(t[n].ModuleCode,t[n].Semester).then(function(o){""===o.data?(console.log("Failed : "+t[n].ModuleCode),e.takenMods.push({ModuleCode:t[n].ModuleCode,ModuleTitle:t[n].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",ModuleGrade:"-",AcadYear:t[n].AcadYear,Semester:t[n].Semester})):(console.log("Success : "+o.data.ModuleCode),e.takenMods.push({ModuleCode:o.data.ModuleCode,ModuleTitle:o.data.ModuleTitle,ModuleCredit:o.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",ModuleGrade:"-",AcadYear:t[n].AcadYear,Semester:t[n].Semester}))})})},function(e){console.log("error no mods found")})},function(o){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var o={method:"GET",url:"index.php?id=checkToken&token="+token};t(o).then(function(o){if(console.log("test : "+o.data),console.log(o.data.Success),$result=o.data.Success,0==$result)n.path("/login");else{var t=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",t),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(t,n){t>=i?angular.isDefined(o.get("toggle"))?e.toggle=!!o.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,o.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0));var userName,studentId;angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q",MasterCtrl]);
