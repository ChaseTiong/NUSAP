...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,s){e[o]=s});return e}function MasterCtrl(e,t,o,s,r,a,d,n){function i(){return o({method:"GET",url:"index.php?id=majorReq&maj=cs"})}function u(){return o({method:"GET",url:"index.php?id=profile&token="+token})}function l(e){return o({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function c(e,t,s){return o({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t+"&acadYear="+s})}function g(){return o({method:"GET",url:"index.php?id=modSearch"})}function S(){var e=[];i().then(function(t){var o=JSON.parse(sessionStorage.getItem("matricYear"));o=parseInt(o),2015>o&&(o=2015);var s="matric"+o,r=t.data[s];e=r[0].totalModules[0].mods;var a=r[0].requiredMc;sessionStorage.setItem("coreRequiredMc",a),sessionStorage.setItem("coreModules",JSON.stringify(e))})}function m(){var e=[];i().then(function(t){var o=JSON.parse(sessionStorage.getItem("matricYear"));o=parseInt(o),2015>o&&(o=2015);for(var s="matric"+o,r=t.data[s],a=r[1].totalModules.length,d=0;a>d;d++)e.push(r[1].totalModules[d].mods);var n=r[1].requiredMc;sessionStorage.setItem("projectRequiredMc",n),sessionStorage.setItem("project8thMcModules",JSON.stringify(e))})}function M(){var e=[];i().then(function(t){var o=JSON.parse(sessionStorage.getItem("matricYear"));o=parseInt(o),2015>o&&(o=2015);for(var s="matric"+o,r=t.data[s],a=r[2].totalModules.length,d=0;a>d;d++)e.push(r[2].totalModules[d].mods);var n=r[2].requiredMc;sessionStorage.setItem("internshipRequiredMc",n),sessionStorage.setItem("internshipModules",JSON.stringify(e))})}function f(){var e=[];i().then(function(t){var o=JSON.parse(sessionStorage.getItem("matricYear"));o=parseInt(o),2015>o&&(o=2015);var s="matric"+o,r=t.data[s];e=r[3].totalModules[0].mods;var a=r[3].requiredMc;sessionStorage.setItem("mathSciRequiredMc",a),sessionStorage.setItem("mathSciModules",JSON.stringify(e))})}function p(){var e=[];i().then(function(t){var o=JSON.parse(sessionStorage.getItem("matricYear"));o=parseInt(o),2015>o&&(o=2015);var s="matric"+o,r=t.data[s];e=r[4].totalModules[0].mods;var a=r[4].requiredMc;sessionStorage.setItem("breathDepthRequiredMc",a),sessionStorage.setItem("breathDepthModules",JSON.stringify(e))})}function h(){var e=[];i().then(function(t){var o=JSON.parse(sessionStorage.getItem("matricYear"));o=parseInt(o),2015>o&&(o=2015);var s="matric"+o,r=t.data[s];e=r[5].totalModules[0].mods;var a=r[5].requiredMc;sessionStorage.setItem("ULRRequiredMc",a),sessionStorage.setItem("ULRModules",JSON.stringify(e))})}function I(t,o,s){c(t,o,s).then(function(o){if(""!==o.data){var s=[];e.preclusionList.push(t),void 0!==o.data.Preclusion&&(s=o.data.Preclusion.split(","),angular.forEach(s,function(t,o){if(-1==s[o].trim().indexOf("or")&&-1==s[o].trim().indexOf("OR")&&-1==s[o].trim().indexOf("and")&&-1==s[o].trim().indexOf("/"))s[o].trim().length<9&&e.preclusionList.push(s[o].trim());else if(-1!=s[o].trim().indexOf(" or ")){var r=[];r=s[o].trim().split(" or "),angular.forEach(r,function(t,o){if(-1==r[o].indexOf(" OR "))r[o].trim().length<9&&e.preclusionList.push(r[o].trim());else{var s=[];s=r[o].trim().split(" OR "),angular.forEach(s,function(t,o){s[o].trim().length<9&&e.preclusionList.push(s[o].trim())})}})}else if(-1!=s[o].trim().indexOf(" OR ")){var r=[];r=s[o].trim().split(" OR "),angular.forEach(r,function(t,o){r[o].trim().length<9&&e.preclusionList.push(r[o].trim())})}else if(-1!=s[o].trim().indexOf(" and ")){var r=[];r=s[o].trim().split(" and "),angular.forEach(r,function(t,o){r[o].trim().length<9&&e.preclusionList.push(r[o].trim())})}else if(-1!=s[o].trim().indexOf("/")){var r=[];r=s[o].trim().split("/"),angular.forEach(r,function(t,o){r[o].trim().length<9&&e.preclusionList.push(r[o].trim())})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList));var r=JSON.parse(sessionStorage.getItem("UEModules")),a=parseInt(sessionStorage.getItem("UERequiredMc")),d=JSON.parse(sessionStorage.getItem("coreModules")),n=parseInt(sessionStorage.getItem("coreRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=d.indexOf(e)&&(d.splice(d.indexOf(e),1),sessionStorage.setItem("coreModules",JSON.stringify(d)),n-=4,0>=n&&(n=0),sessionStorage.setItem("coreRequiredMc",n),angular.forEach(r,function(t,o){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}))}),angular.forEach(r,function(e,t){"CS1101S"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"CS1010R"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"CS2103"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"IS2101"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"ES1102"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"ES1103"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"CFG1010"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))});var i=JSON.parse(sessionStorage.getItem("project8thMcModules")),u=parseInt(sessionStorage.getItem("projectRequiredMc"));angular.forEach(e.preclusionList,function(e,t){angular.forEach(i,function(t,o){-1!=t.indexOf(e)&&(t.splice(t.indexOf(e),1),sessionStorage.setItem("project8thMcModules",JSON.stringify(i)),u-=4,0>=u&&(u=0),sessionStorage.setItem("projectRequiredMc",u),angular.forEach(r,function(t,o){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}))})});var l=JSON.parse(sessionStorage.getItem("internshipModules")),c=parseInt(sessionStorage.getItem("internshipRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=l[0].indexOf(e)?(l[0].splice(l[0].indexOf(e),1),sessionStorage.setItem("internshipModules",JSON.stringify(l)),c-=12,angular.forEach(r,function(t,o){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))})):-1!=l[1].indexOf(e)&&(l[1].splice(l[1].indexOf(e),1),sessionStorage.setItem("internshipModules",JSON.stringify(l)),c-=6,angular.forEach(r,function(t,o){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))})),sessionStorage.setItem("internshipRequiredMc",c)});var g=JSON.parse(sessionStorage.getItem("mathSciModules")),S=parseInt(sessionStorage.getItem("mathSciRequiredMc")),m=JSON.parse(sessionStorage.getItem("modsTaken"));angular.forEach(e.preclusionList,function(e,t){-1!=g.indexOf(e)&&(g.splice(g.indexOf(e),1),sessionStorage.setItem("mathSciModules",JSON.stringify(g)),angular.forEach(m,function(t,o){t.ModuleCode===e&&(S-=4)}),angular.forEach(r,function(t,o){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}),sessionStorage.setItem("mathSciRequiredMc",S))}),-1==g.indexOf("MA1521")&&-1!=g.indexOf("MA1301")&&(g.splice(g.indexOf("MA1301"),1),sessionStorage.setItem("mathSciModules",JSON.stringify(g)),S-=4,sessionStorage.setItem("mathSciRequiredMc",S));var M=JSON.parse(sessionStorage.getItem("breathDepthModules")),f=parseInt(sessionStorage.getItem("breathDepthRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=M.indexOf(e)&&(0>=f&&-1!=r.indexOf(e)&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r)),a-=4,sessionStorage.setItem("UERequiredMc",a)),M.splice(M.indexOf(e),1),sessionStorage.setItem("breathDepthModules",JSON.stringify(M)),f-=4,sessionStorage.setItem("breathDepthRequiredMc",f),angular.forEach(r,function(t,o){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}))});var p=JSON.parse(sessionStorage.getItem("ULRModules")),h=parseInt(sessionStorage.getItem("ULRRequiredMc")),I=JSON.parse(sessionStorage.getItem("modsTaken"));angular.forEach(e.preclusionList,function(e,t){-1!=p.indexOf(e)&&(p.splice(p.indexOf(e),1),sessionStorage.setItem("ULRModules",JSON.stringify(p)),angular.forEach(I,function(t,o){t.ModuleCode===e&&(h-=4)}),sessionStorage.setItem("ULRRequiredMc",h),angular.forEach(r,function(t,o){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}))}),e.$applyAsync(function(){e.currentULR=((20-h)/20*100).toFixed(0),e.currentCore=((120-(f+n+u+c+S))/120*100).toFixed(0),r.length>=0?e.currentUE=(r.length/5*100).toFixed(0):e.currentUE=0,e.overallProgress=(parseInt(e.currentULR)+parseInt(e.currentCore)+parseInt(e.currentUE))/3,e.overallProgress=e.overallProgress.toFixed(0)+"%",e.currentULR=e.currentULR+"%",e.currentCore=e.currentCore+"%",e.currentUE>100?e.currentUE="100%":e.currentUE=e.currentUE+"%"})})}e.$on("$stateChangeSuccess",function(){e.dashboardLoading=!1,e.searchLoading=!0,n(function(){e.dashboardLoading=!0},6e3)});var C=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},e.preclusionList=[],e.modList=[],e.notPrecluded=!0,e.prerequisiteNotFulfill=!0,e.filterCore=function(){e.$applyAsync(function(){e.currentCore="10%",console.log(JSON.parse(sessionStorage.getItem("coreModules")))})},e.filterULR=function(){e.modList=[],e.$applyAsync(function(){var t=new Date,o=t.getFullYear(),s=parseInt(t.getMonth())+1,r=1;7>s&&(o=parseInt(o)-1,r=2);var a=o+"/"+(parseInt(o)+1);e.modList.length=0,e.searchLoading=!1,n(function(){e.searchLoading=!0},3e3);var d=JSON.parse(sessionStorage.getItem("ULRModules")),i=JSON.parse(sessionStorage.getItem("preclusionList"));angular.forEach(d,function(t,o){c(t,r,a).then(function(t){""!=t.data&&-1==i.indexOf(t.data.ModuleCode)&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No",colorCode:"#f08080"})})})})},e.filterCore=function(){e.modList=[],e.$applyAsync(function(){e.searchLoading=!1,n(function(){e.searchLoading=!0},3e3);var t=new Date,o=t.getFullYear(),s=parseInt(t.getMonth())+1,r=1;7>s&&(o=parseInt(o)-1,r=2);var a=o+"/"+(parseInt(o)+1);e.modList.length=0;var d=JSON.parse(sessionStorage.getItem("preclusionList")),i=JSON.parse(sessionStorage.getItem("coreModules")),u=JSON.parse(sessionStorage.getItem("breathDepthModules")),l=parseInt(sessionStorage.getItem("internshipRequiredMc"));if(12>l)var g=JSON.parse(sessionStorage.getItem("internshipModules"))[1];else{var g=JSON.parse(sessionStorage.getItem("internshipModules"))[1];g.unshift(JSON.parse(sessionStorage.getItem("internshipModules"))[0][0])}var S=JSON.parse(sessionStorage.getItem("mathSciModules")),m=JSON.parse(sessionStorage.getItem("project8thMcModules"));angular.forEach(i,function(t,o){c(t,r,a).then(function(t){""!=t.data&&-1==d.indexOf(t.data.ModuleCode)&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No",colorCode:"#cff2fd"})})}),angular.forEach(S,function(t,o){c(t,r,a).then(function(t){""!=t.data&&-1==d.indexOf(t.data.ModuleCode)&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No",colorCode:"#baeee0"})})}),angular.forEach(g,function(t,o){c(t,r,a).then(function(t){""!=t.data&&-1==d.indexOf(t.data.ModuleCode)&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No",colorCode:"#cff2fd"})})}),angular.forEach(u,function(t,o){c(t,r,a).then(function(t){""!=t.data&&-1==d.indexOf(t.data.ModuleCode)&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No",colorCode:"#cff2fd"})})}),angular.forEach(m,function(t,o){for(var s=0;s<t.length;s++)c(t[s],r,a).then(function(t){""!=t.data&&-1==d.indexOf(t.data.ModuleCode)&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No",colorCode:"#cff2fd"})})})})},g().then(function(t){sessionStorage.setItem("modsList",JSON.stringify(t.data));var o=JSON.parse(sessionStorage.getItem("modsList"));e.tempModList=o}),e.isUpdated=!1,e.updateModList=function(t){var o=sessionStorage.getItem("oldText");if(null==o&&(o=""),e.searchLoading=!1,n(function(){e.searchLoading=!0},2e3),t=t.toUpperCase(),console.log("current Text : "+t),t.length<1)e.modList=[],e.isUpdated=!0;else if(o.length<t.length){e.modList=[];for(var s=JSON.parse(sessionStorage.getItem("preclusionList")),r=0;r<e.tempModList.length;r++)e.tempModList[r].ModuleCode.includes(t)&&-1==s.indexOf(e.tempModList[r].ModuleCode)&&e.modList.push({ModuleCode:e.tempModList[r].ModuleCode,ModuleTitle:e.tempModList[r].ModuleTitle,Semesters:e.tempModList[r].Semesters})}else{if(0==e.isUpdate){e.modList=[];for(var r=0;r<e.tempModList.length;r++)e.tempModList[r].ModuleCode.includes(t)&&e.modList.push({ModuleCode:e.tempModList[r].ModuleCode,ModuleTitle:e.tempModList[r].ModuleTitle,Semesters:e.tempModList[r].Semesters})}else{var a=e.modList;e.modList=[];for(var r=0;r<a.length;r++)a[r].ModuleCode.includes(t)&&e.modList.push({ModuleCode:a[r].ModuleCode,ModuleTitle:a[r].ModuleTitle,Semesters:a[r].Semesters})}sessionStorage.setItem("oldText",t)}0==e.modList.length&&console.log("TEST")},e.getProfile=function(){function t(e){e=parseInt(e);for(var t=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(0,4)),o=[],s=new Date,r=(s.getFullYear(),parseInt(s.getMonth())+1),a=e;t>=a;a++){var d=a+1;if(t>a){var n=a+"/"+d+"-1";o.push(n),n=a+"/"+d+"-2",o.push(n)}else if(7>r){var n=a+"/"+d+"-1";o.push(n),n=a+"/"+d+"-2",o.push(n)}else{var n=a+"/"+d+"-1";o.push(n)}}var i=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].Semester);if(2==i){var n=(o[o.length-1],JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(0,9));n+="-2",o.push(n)}return o}u().then(function(o){console.log(o.data),e.username=o.data.Results[0].Name,S(),m(),M(),f(),p(),h(),sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",o.data.Results[0].UserID),sessionStorage.setItem("firstMajor",o.data.Results[0].FirstMajor),sessionStorage.setItem("secondMajor",o.data.Results[0].SecondMajor),sessionStorage.setItem("matricYear",o.data.Results[0].MatriculationYear),e.plannerSize=[],e.unlockSem=[];for(var s=4,r=o.data.Results[0].MatriculationYear,a=0;s>a;a++)e.plannerSize.push({candidatureYear:parseInt(r)+a+"/"+(parseInt(r)+a+1)});e.addYear=function(){if(s+=1,!(s>6)){var t={candidatureYear:parseInt(r)+s-1+"/"+(parseInt(r)+s)};e.plannerSize.push(t)}},l(o.data.Results[0].UserID).then(function(o){e.modsCount=o.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(o.data.Results)),sessionStorage.setItem("UEModules",JSON.stringify(o.data.Results)),sessionStorage.setItem("UERequiredMc",20),e.specialMods=[],e.modsPerSem=[];var s=JSON.parse(sessionStorage.getItem("modsTaken"));JSON.parse(sessionStorage.getItem("modsTaken")).length;sessionStorage.setItem("userSem",JSON.stringify(t(JSON.parse(sessionStorage.getItem("matricYear"))))),console.log("test result : "+t(JSON.parse(sessionStorage.getItem("matricYear"))));var r=JSON.parse(sessionStorage.getItem("userSem"));angular.forEach(r,function(t,o){e.takenMods=[];var a=[];e.unlockSem.push(!1),angular.forEach(s,function(t,d){s[d].Semester==r[o].substring(10,11)&&s[d].AcadYear==r[o].substring(0,9)&&c(s[d].ModuleCode,s[d].Semester,s[d].AcadYear).then(function(t){var o=parseInt(sessionStorage.getItem("totalCreditTaken"));if(e.$applyAsync(function(){}),""===t.data)o+=4,sessionStorage.setItem("totalCreditTaken",o),a.unshift({ModuleCode:s[d].ModuleCode,ModuleTitle:s[d].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[d].AcadYear,Semester:s[d].Semester,type:"UE",colorCode:"#ffedc4"}),e.takenMods.push({ModuleCode:s[d].ModuleCode,ModuleTitle:s[d].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[d].AcadYear,Semester:s[d].Semester,type:"UE",colorCode:"#ffedc4"}),a[0].selectedModGrade=a[0].ModuleGrade[0],a[0].selectedModSuStatus=a[0].ModuleSuStatus[0],sessionStorage.setItem(s[d].ModuleCode,JSON.stringify({ModuleTitle:s[d].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:"-",AcadYear:s[d].AcadYear,Semester:s[d].Semester,type:"UE",colorCode:"#ffedc4"}));else{if(o+=parseInt(t.data.ModuleCredit),sessionStorage.setItem("totalCreditTaken",o),I(t.data.ModuleCode,s[d].Semester,s[d].AcadYear),-1!=t.data.ModuleCode.indexOf("CS")||-1!=t.data.ModuleCode.indexOf("CP"))var r="#cff2fd";else if(-1!=t.data.ModuleCode.indexOf("MA")||-1!=t.data.ModuleCode.indexOf("LSM")||-1!=t.data.ModuleCode.indexOf("PC")||-1!=t.data.ModuleCode.indexOf("CM")||-1!=t.data.ModuleCode.indexOf("ST"))var r="#baeee0";else if(-1!=t.data.ModuleCode.indexOf("IS"))var r="#fbbaca";else if(-1!=t.data.ModuleCode.indexOf("GE"))var r="#f08080";else var r="#ffedc4";a.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[d].AcadYear,Semester:s[d].Semester,type:"CORE",colorCode:r}),e.takenMods.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[d].AcadYear,Semester:s[d].Semester,type:"CORE",colorCode:r}),sessionStorage.setItem(t.data.ModuleCode,JSON.stringify({ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:"-",AcadYear:s[d].AcadYear,Semester:s[d].Semester,type:"CORE",colorCode:r}))}})}),e.modsPerSem.push(a)}),e.addSemester=function(){var t=[],o=JSON.parse(sessionStorage.getItem("userSem")).length;t=JSON.parse(sessionStorage.getItem("userSem"));var s=JSON.parse(sessionStorage.getItem("userSem"))[o-1],r=s.substring(10),a=parseInt(s.substring(0,4)),d=parseInt(s.substring(5,9)),n="",i=0;1==r?(i=2,n=a+"/"+d+"-"+i):(i=1,n=d+"/"+(d+1)+"-"+i),t.push(n),sessionStorage.setItem("userSem",JSON.stringify(t)),e.unlockSem[o]=!0,e.tempStorage=[];var i=(o+1)%2;0==i&&(i=2);for(var u=0;5>u;u++)e.tempStorage.push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:"-",selectedModGrade:"-",ModuleGrade:["-"],AcadYear:n.substring(0,9),Semester:i,type:null,colorCode:"#ffedc4"});e.modsPerSem.push(e.tempStorage)},console.log(r.length);for(var a=r.length;8>a;a++)e.addSemester();console.log(r.length),e.removeMod=function(t){angular.forEach(e.modsPerSem,function(t,o){return console.log("--"),""==e.modsPerSem[o].ModuleTitle?(console.log("-"),void e.modsPerSem[o].splice(0,1)):void 0}),e.modList.splice(t,1)},e.findType=function(e){document.getElementById("type")}},function(e){console.log("error no mods found")})},function(t){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var t={method:"GET",url:"index.php?id=checkToken&token="+token};o(t).then(function(t){if($result=t.data.Success,0==$result)s.path("/login");else{var o=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",o),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},$(".popup").mouseover(function(){$(this).children(".moduleDetails").show()}).mouseout(function(){$(this).children(".moduleDetails").hide()}),$(document).ready(function(){var e;new Clipboard(".invite-link"),$.ajax({url:"https://www.googleapis.com/urlshortener/v1/url?key=AIzaSyBsoXP_gCh3umRVKqP5MOHfEHs1fxK84g0",type:"POST",data:JSON.stringify({longUrl:window.location.href}),contentType:"application/json",dataType:"json",success:function(t){e=t.id,$(".invite-link").attr("data-clipboard-text",e)}}),$(".invite-link").click(function(){var t=$("#invite-link");t.attr("value",e)})}),e.$watch(e.getWidth,function(o,s){o>=C?angular.isDefined(t.get("toggle"))?e.toggle=!!t.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,t.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0),history.replaceState({},null,"index.html"));var userName,studentId;sessionStorage.setItem("totalCreditTaken",0),angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q","$log","$timeout",MasterCtrl]);
