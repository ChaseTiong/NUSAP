...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,s,o){e[s]=o});return e}function MasterCtrl(e,t,s,o,r,a,n,i){function d(){return s({method:"GET",url:"index.php?id=majorReq&maj=cs"})}function u(){return s({method:"GET",url:"index.php?id=profile&token="+token})}function l(e){return s({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function c(e,t,o){return s({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t+"&acadYear="+o})}function g(){return s({method:"GET",url:"index.php?id=modSearch"})}function S(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear"));s=parseInt(s),2015>s&&(s=2015);var o="matric"+s,r=t.data[o];e=r[0].totalModules[0].mods;var a=r[0].requiredMc;sessionStorage.setItem("coreRequiredMc",a),sessionStorage.setItem("coreModules",JSON.stringify(e))})}function m(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear"));s=parseInt(s),2015>s&&(s=2015);for(var o="matric"+s,r=t.data[o],a=r[1].totalModules.length,n=0;a>n;n++)e.push(r[1].totalModules[n].mods);var i=r[1].requiredMc;sessionStorage.setItem("projectRequiredMc",i),sessionStorage.setItem("project8thMcModules",JSON.stringify(e))})}function M(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear"));s=parseInt(s),2015>s&&(s=2015);for(var o="matric"+s,r=t.data[o],a=r[2].totalModules.length,n=0;a>n;n++)e.push(r[2].totalModules[n].mods);var i=r[2].requiredMc;sessionStorage.setItem("internshipRequiredMc",i),sessionStorage.setItem("internshipModules",JSON.stringify(e))})}function p(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear"));s=parseInt(s),2015>s&&(s=2015);var o="matric"+s,r=t.data[o];e=r[3].totalModules[0].mods;var a=r[3].requiredMc;sessionStorage.setItem("mathSciRequiredMc",a),sessionStorage.setItem("mathSciModules",JSON.stringify(e))})}function f(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear"));s=parseInt(s),2015>s&&(s=2015);var o="matric"+s,r=t.data[o];e=r[4].totalModules[0].mods;var a=r[4].requiredMc;sessionStorage.setItem("breathDepthRequiredMc",a),sessionStorage.setItem("breathDepthModules",JSON.stringify(e))})}function h(){var e=[];d().then(function(t){var s=JSON.parse(sessionStorage.getItem("matricYear"));s=parseInt(s),2015>s&&(s=2015);var o="matric"+s,r=t.data[o];e=r[5].totalModules[0].mods;var a=r[5].requiredMc;sessionStorage.setItem("ULRRequiredMc",a),sessionStorage.setItem("ULRModules",JSON.stringify(e))})}function I(t,s,o){c(t,s,o).then(function(s){if(""!==s.data){var o=[];e.preclusionList.push(t),void 0!==s.data.Preclusion&&(o=s.data.Preclusion.split(","),angular.forEach(o,function(t,s){if(-1==o[s].trim().indexOf("or")&&-1==o[s].trim().indexOf("OR")&&-1==o[s].trim().indexOf("and")&&-1==o[s].trim().indexOf("/"))o[s].trim().length<9&&e.preclusionList.push(o[s].trim());else if(-1!=o[s].trim().indexOf(" or ")){var r=[];r=o[s].trim().split(" or "),angular.forEach(r,function(t,s){if(-1==r[s].indexOf(" OR "))r[s].trim().length<9&&e.preclusionList.push(r[s].trim());else{var o=[];o=r[s].trim().split(" OR "),angular.forEach(o,function(t,s){o[s].trim().length<9&&e.preclusionList.push(o[s].trim())})}})}else if(-1!=o[s].trim().indexOf(" OR ")){var r=[];r=o[s].trim().split(" OR "),angular.forEach(r,function(t,s){r[s].trim().length<9&&e.preclusionList.push(r[s].trim())})}else if(-1!=o[s].trim().indexOf(" and ")){var r=[];r=o[s].trim().split(" and "),angular.forEach(r,function(t,s){r[s].trim().length<9&&e.preclusionList.push(r[s].trim())})}else if(-1!=o[s].trim().indexOf("/")){var r=[];r=o[s].trim().split("/"),angular.forEach(r,function(t,s){r[s].trim().length<9&&e.preclusionList.push(r[s].trim())})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList));var r=JSON.parse(sessionStorage.getItem("UEModules")),a=parseInt(sessionStorage.getItem("UERequiredMc")),n=JSON.parse(sessionStorage.getItem("coreModules")),i=parseInt(sessionStorage.getItem("coreRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=n.indexOf(e)&&(n.splice(n.indexOf(e),1),sessionStorage.setItem("coreModules",JSON.stringify(n)),i-=4,0>=i&&(i=0),sessionStorage.setItem("coreRequiredMc",i),angular.forEach(r,function(t,s){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}))}),angular.forEach(r,function(e,t){"CS1101S"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"CS1010R"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"CS2103"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"IS2101"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"ES1102"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"ES1103"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r))),"CFG1010"===e.ModuleCode&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))});var d=JSON.parse(sessionStorage.getItem("project8thMcModules")),u=parseInt(sessionStorage.getItem("projectRequiredMc"));angular.forEach(e.preclusionList,function(e,t){angular.forEach(d,function(t,s){-1!=t.indexOf(e)&&(t.splice(t.indexOf(e),1),sessionStorage.setItem("project8thMcModules",JSON.stringify(d)),u-=4,0>=u&&(u=0),sessionStorage.setItem("projectRequiredMc",u),angular.forEach(r,function(t,s){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}))})});var l=JSON.parse(sessionStorage.getItem("internshipModules")),c=parseInt(sessionStorage.getItem("internshipRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=l[0].indexOf(e)?(l[0].splice(l[0].indexOf(e),1),sessionStorage.setItem("internshipModules",JSON.stringify(l)),c-=12,angular.forEach(r,function(t,s){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))})):-1!=l[1].indexOf(e)&&(l[1].splice(l[1].indexOf(e),1),sessionStorage.setItem("internshipModules",JSON.stringify(l)),c-=6,angular.forEach(r,function(t,s){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))})),sessionStorage.setItem("internshipRequiredMc",c)});var g=JSON.parse(sessionStorage.getItem("mathSciModules")),S=parseInt(sessionStorage.getItem("mathSciRequiredMc")),m=JSON.parse(sessionStorage.getItem("modsTaken"));angular.forEach(e.preclusionList,function(e,t){-1!=g.indexOf(e)&&(g.splice(g.indexOf(e),1),sessionStorage.setItem("mathSciModules",JSON.stringify(g)),angular.forEach(m,function(t,s){t.ModuleCode===e&&(S-=4)}),angular.forEach(r,function(t,s){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}),sessionStorage.setItem("mathSciRequiredMc",S))}),-1==g.indexOf("MA1521")&&-1!=g.indexOf("MA1301")&&(g.splice(g.indexOf("MA1301"),1),sessionStorage.setItem("mathSciModules",JSON.stringify(g)),S-=4,sessionStorage.setItem("mathSciRequiredMc",S));var M=JSON.parse(sessionStorage.getItem("breathDepthModules")),p=parseInt(sessionStorage.getItem("breathDepthRequiredMc"));angular.forEach(e.preclusionList,function(e,t){-1!=M.indexOf(e)&&(0>=p&&-1!=r.indexOf(e)&&(r.splice(r.indexOf(e),1),sessionStorage.setItem("UEModules",JSON.stringify(r)),a-=4,sessionStorage.setItem("UERequiredMc",a)),M.splice(M.indexOf(e),1),sessionStorage.setItem("breathDepthModules",JSON.stringify(M)),p-=4,sessionStorage.setItem("breathDepthRequiredMc",p),angular.forEach(r,function(t,s){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}))});var f=JSON.parse(sessionStorage.getItem("ULRModules")),h=parseInt(sessionStorage.getItem("ULRRequiredMc")),I=JSON.parse(sessionStorage.getItem("modsTaken"));angular.forEach(e.preclusionList,function(e,t){-1!=f.indexOf(e)&&(f.splice(f.indexOf(e),1),sessionStorage.setItem("ULRModules",JSON.stringify(f)),angular.forEach(I,function(t,s){t.ModuleCode===e&&(h-=4)}),sessionStorage.setItem("ULRRequiredMc",h),angular.forEach(r,function(t,s){t.ModuleCode===e&&(r.splice(r.indexOf(t),1),sessionStorage.setItem("UEModules",JSON.stringify(r)))}))}),e.$applyAsync(function(){e.currentULR=((20-h)/20*100).toFixed(0),e.currentCore=((120-(p+i+u+c+S))/120*100).toFixed(0),r.length>=0?e.currentUE=(r.length/5*100).toFixed(0):e.currentUE=0,e.overallProgress=(parseInt(e.currentULR)+parseInt(e.currentCore)+parseInt(e.currentUE))/3,e.overallProgress=e.overallProgress.toFixed(0)+"%",e.currentULR=e.currentULR+"%",e.currentCore=e.currentCore+"%",e.currentUE>100?e.currentUE="100%":e.currentUE=e.currentUE+"%"})})}e.$on("$stateChangeSuccess",function(){e.dashboardLoading=!1,e.searchLoading=!0,i(function(){e.dashboardLoading=!0},6e3)});var O=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},e.preclusionList=[],e.modList=[],e.notPrecluded=!0,e.prerequisiteNotFulfill=!0,e.filterCore=function(){e.$applyAsync(function(){e.currentCore="10%",console.log(JSON.parse(sessionStorage.getItem("coreModules")))})},e.filterULR=function(){e.modList=[],e.$applyAsync(function(){var t=new Date,s=t.getFullYear(),o=parseInt(t.getMonth())+1,r=1;7>o&&(s=parseInt(s)-1,r=2);var a=s+"/"+(parseInt(s)+1);e.modList.length=0,e.searchLoading=!1,i(function(){e.searchLoading=!0},3e3);var n=JSON.parse(sessionStorage.getItem("ULRModules"));angular.forEach(n,function(t,s){c(t,r,a).then(function(t){""!=t.data&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No"})})})})},e.filterCore=function(){e.modList=[],e.$applyAsync(function(){e.searchLoading=!1,i(function(){e.searchLoading=!0},3e3);var t=new Date,s=t.getFullYear(),o=parseInt(t.getMonth())+1,r=1;7>o&&(s=parseInt(s)-1,r=2);var a=s+"/"+(parseInt(s)+1);e.modList.length=0;var n=JSON.parse(sessionStorage.getItem("coreModules")),d=JSON.parse(sessionStorage.getItem("breathDepthModules")),u=parseInt(sessionStorage.getItem("internshipRequiredMc"));if(12>u)var l=JSON.parse(sessionStorage.getItem("internshipModules"))[1];else{var l=JSON.parse(sessionStorage.getItem("internshipModules"))[1];l.unshift(JSON.parse(sessionStorage.getItem("internshipModules"))[0][0])}var g=JSON.parse(sessionStorage.getItem("mathSciModules")),S=JSON.parse(sessionStorage.getItem("project8thMcModules"));angular.forEach(n,function(t,s){c(t,r,a).then(function(t){""!=t.data&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No"})})}),angular.forEach(g,function(t,s){c(t,r,a).then(function(t){""!=t.data&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No"})})}),angular.forEach(l,function(t,s){c(t,r,a).then(function(t){""!=t.data&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No"})})}),angular.forEach(d,function(t,s){c(t,r,a).then(function(t){""!=t.data&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No"})})}),angular.forEach(S,function(t,s){for(var o=0;o<t.length;o++)c(t[o],r,a).then(function(t){""!=t.data&&e.modList.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],modFound:!0,selectedModGrade:"-",selectedModSuStatus:"No"})})})})},g().then(function(t){sessionStorage.setItem("modsList",JSON.stringify(t.data));var s=JSON.parse(sessionStorage.getItem("modsList"));e.tempModList=s}),e.isUpdated=!1,e.updateModList=function(t){var s=sessionStorage.getItem("oldText");if(null==s&&(s=""),e.searchLoading=!1,i(function(){e.searchLoading=!0},2e3),t=t.toUpperCase(),console.log("current Text : "+t),t.length<1)e.modList=[],e.isUpdated=!0;else if(s.length<t.length){e.modList=[];for(var o=0;o<e.tempModList.length;o++)e.tempModList[o].ModuleCode.includes(t)&&e.modList.push({ModuleCode:e.tempModList[o].ModuleCode,ModuleTitle:e.tempModList[o].ModuleTitle,Semesters:e.tempModList[o].Semesters})}else{if(0==e.isUpdate){e.modList=[];for(var o=0;o<e.tempModList.length;o++)e.tempModList[o].ModuleCode.includes(t)&&e.modList.push({ModuleCode:e.tempModList[o].ModuleCode,ModuleTitle:e.tempModList[o].ModuleTitle,Semesters:e.tempModList[o].Semesters})}else{var r=e.modList;e.modList=[];for(var o=0;o<r.length;o++)r[o].ModuleCode.includes(t)&&e.modList.push({ModuleCode:r[o].ModuleCode,ModuleTitle:r[o].ModuleTitle,Semesters:r[o].Semesters})}sessionStorage.setItem("oldText",t)}},e.getProfile=function(){function t(e){e=parseInt(e);for(var t=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(0,4)),s=[],o=new Date,r=(o.getFullYear(),parseInt(o.getMonth())+1),a=e;t>=a;a++){var n=a+1;if(t>a){var i=a+"/"+n+"-1";s.push(i),i=a+"/"+n+"-2",s.push(i)}else if(7>r){var i=a+"/"+n+"-1";s.push(i),i=a+"/"+n+"-2",s.push(i)}else{var i=a+"/"+n+"-1";s.push(i)}}var d=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].Semester);if(2==d){var i=(s[s.length-1],JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(0,9));i+="-2",s.push(i)}return s}u().then(function(s){console.log(s.data),e.username=s.data.Results[0].Name,S(),m(),M(),p(),f(),h(),sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",s.data.Results[0].UserID),sessionStorage.setItem("firstMajor",s.data.Results[0].FirstMajor),sessionStorage.setItem("secondMajor",s.data.Results[0].SecondMajor),sessionStorage.setItem("matricYear",s.data.Results[0].MatriculationYear),e.plannerSize=[],e.unlockSem=[];for(var o=4,r=s.data.Results[0].MatriculationYear,a=0;o>a;a++)e.plannerSize.push({candidatureYear:parseInt(r)+a+"/"+(parseInt(r)+a+1)});e.addYear=function(){if(o+=1,!(o>6)){var t={candidatureYear:parseInt(r)+o-1+"/"+(parseInt(r)+o)};e.plannerSize.push(t)}},l(s.data.Results[0].UserID).then(function(s){e.modsCount=s.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(s.data.Results)),sessionStorage.setItem("UEModules",JSON.stringify(s.data.Results)),sessionStorage.setItem("UERequiredMc",20),e.specialMods=[],e.modsPerSem=[];var o=JSON.parse(sessionStorage.getItem("modsTaken"));JSON.parse(sessionStorage.getItem("modsTaken")).length;sessionStorage.setItem("userSem",JSON.stringify(t(JSON.parse(sessionStorage.getItem("matricYear"))))),console.log("test result : "+t(JSON.parse(sessionStorage.getItem("matricYear"))));var r=JSON.parse(sessionStorage.getItem("userSem"));angular.forEach(r,function(t,s){e.takenMods=[];var a=[];e.unlockSem.push(!1),angular.forEach(o,function(t,n){o[n].Semester==r[s].substring(10,11)&&o[n].AcadYear==r[s].substring(0,9)&&c(o[n].ModuleCode,o[n].Semester,o[n].AcadYear).then(function(t){var s=parseInt(sessionStorage.getItem("totalCreditTaken"));e.$applyAsync(function(){}),""===t.data?(s+=4,sessionStorage.setItem("totalCreditTaken",s),a.unshift({ModuleCode:o[n].ModuleCode,ModuleTitle:o[n].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:o[n].AcadYear,Semester:o[n].Semester,type:"UE"}),e.takenMods.push({ModuleCode:o[n].ModuleCode,ModuleTitle:o[n].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:o[n].AcadYear,Semester:o[n].Semester,type:"UE"}),a[0].selectedModGrade=a[0].ModuleGrade[0],a[0].selectedModSuStatus=a[0].ModuleSuStatus[0],sessionStorage.setItem(o[n].ModuleCode,JSON.stringify({ModuleTitle:o[n].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:"-",AcadYear:o[n].AcadYear,Semester:o[n].Semester,type:"UE"}))):(s+=parseInt(t.data.ModuleCredit),sessionStorage.setItem("totalCreditTaken",s),I(t.data.ModuleCode,o[n].Semester,o[n].AcadYear),a.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:o[n].AcadYear,Semester:o[n].Semester}),e.takenMods.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:o[n].AcadYear,Semester:o[n].Semester}),sessionStorage.setItem(t.data.ModuleCode,JSON.stringify({ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:"-",AcadYear:o[n].AcadYear,Semester:o[n].Semester})))})}),e.modsPerSem.push(a)}),e.addSemester=function(){var t=[],s=JSON.parse(sessionStorage.getItem("userSem")).length;t=JSON.parse(sessionStorage.getItem("userSem"));var o=JSON.parse(sessionStorage.getItem("userSem"))[s-1],r=o.substring(10),a=parseInt(o.substring(0,4)),n=parseInt(o.substring(5,9)),i="",d=0;1==r?(d=2,i=a+"/"+n+"-"+d):(d=1,i=n+"/"+(n+1)+"-"+d),t.push(i),sessionStorage.setItem("userSem",JSON.stringify(t)),e.unlockSem[s]=!0,e.tempStorage=[];var d=(s+1)%2;0==d&&(d=2);for(var u=0;5>u;u++)e.tempStorage.push({ModuleCode:"",ModuleTitle:"",ModuleCredit:"",ModuleStatus:"Normal",ModuleSuStatus:["-"],selectedModSuStatus:"-",selectedModGrade:"-",ModuleGrade:["-"],AcadYear:i.substring(0,9),Semester:d,type:null});e.modsPerSem.push(e.tempStorage)},console.log(r.length);for(var a=r.length;8>a;a++)e.addSemester();console.log(r.length),e.removeMod=function(t){angular.forEach(e.modsPerSem,function(t,s){return console.log("--"),""==e.modsPerSem[s].ModuleTitle?(console.log("-"),void e.modsPerSem[s].splice(0,1)):void 0}),e.modList.splice(t,1)},e.findType=function(e){document.getElementById("type")}},function(e){console.log("error no mods found")})},function(t){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var t={method:"GET",url:"index.php?id=checkToken&token="+token};s(t).then(function(t){if($result=t.data.Success,0==$result)o.path("/login");else{var s=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",s),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},$(".popup").mouseover(function(){$(this).children(".moduleDetails").show()}).mouseout(function(){$(this).children(".moduleDetails").hide()}),$(document).ready(function(){var e;new Clipboard(".invite-link"),$.ajax({url:"https://www.googleapis.com/urlshortener/v1/url?key=AIzaSyBsoXP_gCh3umRVKqP5MOHfEHs1fxK84g0",type:"POST",data:JSON.stringify({longUrl:window.location.href}),contentType:"application/json",dataType:"json",success:function(t){e=t.id,$(".invite-link").attr("data-clipboard-text",e)}}),$(".invite-link").click(function(){var t=$("#invite-link");t.attr("value",e)})}),e.$watch(e.getWidth,function(s,o){s>=O?angular.isDefined(t.get("toggle"))?e.toggle=!!t.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,t.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0),history.replaceState({},null,"index.html"));var userName,studentId;sessionStorage.setItem("totalCreditTaken",0),angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q","$log","$timeout",MasterCtrl]);
