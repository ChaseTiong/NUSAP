...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,s){e[o]=s});return e}function MasterCtrl(e,t,o,s,n,a){function d(){return o({method:"GET",url:"index.php?id=profile&token="+token})}function l(e){return o({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function r(e,t){return o({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t})}var u=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},e.getProfile=function(){d().then(function(t){e.username=t.data.Results[0].Name,sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",t.data.Results[0].UserID),sessionStorage.setItem("matricYear",t.data.Results[0].MatriculationYear),l(t.data.Results[0].UserID).then(function(t){e.modsCount=t.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(t.data.Results)),console.log(JSON.parse(sessionStorage.getItem("modsTaken"))),e.takenMods=[],e.specialMods=[];var o=JSON.parse(sessionStorage.getItem("modsTaken")),s=JSON.parse(sessionStorage.getItem("modsTaken")).length;console.log("total mods : "+s),angular.forEach(o,function(t,s){1==o[s].Semester&&r(o[s].ModuleCode,o[s].Semester).then(function(t){""===t.data?(console.log("Failed : "+o[s].ModuleCode),e.takenMods.push({ModuleCode:o[s].ModuleCode,ModuleTitle:o[s].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],ModuleGrade:["-"],AcadYear:o[s].AcadYear,Semester:o[s].Semester}),sessionStorage.setItem(o[s].ModuleCode,JSON.stringify({ModuleTitle:o[s].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",ModuleGrade:"-",AcadYear:o[s].AcadYear,Semester:o[s].Semester}))):(console.log("Success : "+t.data.ModuleCode),e.takenMods.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:o[s].AcadYear,Semester:o[s].Semester}),sessionStorage.setItem(t.data.ModuleCode,JSON.stringify({ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",ModuleGrade:"-",AcadYear:o[s].AcadYear,Semester:o[s].Semester})))})})},function(e){console.log("error no mods found")})},function(t){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var t={method:"GET",url:"index.php?id=checkToken&token="+token};o(t).then(function(t){if(console.log("test : "+t.data),console.log(t.data.Success),$result=t.data.Success,0==$result)s.path("/login");else{var o=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",o),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(o,s){o>=u?angular.isDefined(t.get("toggle"))?e.toggle=!!t.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,t.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0));var userName,studentId;angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q",MasterCtrl]);
