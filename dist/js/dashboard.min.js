...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(o,t,n){e[t]=n});return e}function CapCalCtrl(e,o,t,n){e.testMcs=function(){var o={method:"GET",url:"index.php?id=checkMod&modCode=CP3200"};t(o).then(function(o){e.testResults=o.data.ModuleCredit},function(e){console.log("error")})},e.modsTaken=function(){var o={method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+sessionStorage.netid};t(o).then(function(o){e.modsCount=o.data.Results.length,e.takenMods=[];for(var n=0,d=0;d<e.modsCount;d++)if(2==o.data.Results[d].Semester){var s=o.data.Results[d].ModuleCode,l=o.data.Results[d].ModuleTitle,a=o.data.Results[d].Semester;console.log(s);var r={method:"GET",url:"index.php?id=checkMod&modCode="+s+"&sem="+a};t(r).then(function(o){console.log("current count : "+n),""==o.data?e.takenMods.push({ModuleCode:s,ModuleTitle:l,ModuleCredit:4}):e.takenMods.push({ModuleCode:o.data.ModuleCode,ModuleTitle:o.data.ModuleTitle,ModuleCredit:o.data.ModuleCredit}),n+=1,console.log(e.takenMods[n])},function(e){console.log("error")})}},function(e){console.log("error")})}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0));var userName,studentId;angular.module("NUSAP").controller("CapCalCtrl",["$scope","$cookieStore","$http","$location",CapCalCtrl]);
