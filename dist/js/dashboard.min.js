...
function getUrlVars(){var e={};window.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi,function(t,o,s){e[o]=s});return e}function MasterCtrl(e,t,o,s,d,r,a,n){function i(){return o({method:"GET",url:"index.php?id=majorReq&maj=cs"})}function l(){return o({method:"GET",url:"index.php?id=profile&token="+token})}function u(e){return o({method:"GET",url:"index.php?id=modsTaken&token="+token+"&studentID="+e})}function m(e,t,s){return o({method:"GET",url:"index.php?id=checkMod&modCode="+e+"&sem="+t+"&acadYear="+s})}function c(){return o({method:"GET",url:"index.php?id=modSearch"})}function g(t,o,s){m(t,o,s).then(function(o){if(""!==o.data){var s=[];e.preclusionList.push(t),void 0!==o.data.Preclusion&&(s=o.data.Preclusion.split(","),angular.forEach(s,function(t,o){if(-1==s[o].trim().indexOf("or")&&-1==s[o].trim().indexOf("OR")&&-1==s[o].trim().indexOf("and")&&-1==s[o].trim().indexOf("/"))s[o].trim().length<9&&e.preclusionList.push(s[o].trim());else if(-1!=s[o].trim().indexOf(" or ")){var d=[];d=s[o].trim().split(" or "),angular.forEach(d,function(t,o){if(-1==d[o].indexOf(" OR "))d[o].trim().length<9&&e.preclusionList.push(d[o].trim());else{var s=[];s=d[o].trim().split(" OR "),angular.forEach(s,function(t,o){s[o].trim().length<9&&e.preclusionList.push(s[o].trim())})}})}else if(-1!=s[o].trim().indexOf(" OR ")){var d=[];d=s[o].trim().split(" OR "),angular.forEach(d,function(t,o){d[o].trim().length<9&&e.preclusionList.push(d[o].trim())})}else if(-1!=s[o].trim().indexOf(" and ")){var d=[];d=s[o].trim().split(" and "),angular.forEach(d,function(t,o){d[o].trim().length<9&&e.preclusionList.push(d[o].trim())})}else if(-1!=s[o].trim().indexOf("/")){var d=[];d=s[o].trim().split("/"),angular.forEach(d,function(t,o){d[o].trim().length<9&&e.preclusionList.push(d[o].trim())})}}))}sessionStorage.setItem("preclusionList",JSON.stringify(e.preclusionList))})}e.dashboardLoading=!1,e.searchLoading=!0,n(function(){e.dashboardLoading=!0},3500);var M=992;e.username="",e.showProfile=function(){e.userProfile=!e.userProfile},i().then(function(e){console.log("testing json file"),console.log(e.data.matric2015.Core)}),e.preclusionList=[],e.modList=[],c().then(function(t){sessionStorage.setItem("modsList",JSON.stringify(t.data));var o=JSON.parse(sessionStorage.getItem("modsList"));angular.forEach(o,function(t,s){e.modList.push({ModuleCode:o[s].ModuleCode,ModuleTitle:o[s].ModuleTitle,Semesters:o[s].Semesters})}),e.tempModList=e.modList}),e.isUpdated=!1,e.updateModList=function(t){var o=sessionStorage.getItem("oldText");if(null==o&&(o=""),e.searchLoading=!1,n(function(){e.searchLoading=!0},2e3),t=t.toUpperCase(),console.log("current Text : "+t),t.length<1)e.modList=e.tempModList,e.isUpdated=!0;else if(o.length<t.length){e.modList=[];for(var s=0;s<e.tempModList.length;s++)e.tempModList[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:e.tempModList[s].ModuleCode,ModuleTitle:e.tempModList[s].ModuleTitle,Semesters:e.tempModList[s].Semesters})}else{if(0==e.isUpdate){e.modList=[];for(var s=0;s<e.tempModList.length;s++)e.tempModList[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:e.tempModList[s].ModuleCode,ModuleTitle:e.tempModList[s].ModuleTitle,Semesters:e.tempModList[s].Semesters})}else{var d=e.modList;e.modList=[];for(var s=0;s<d.length;s++)d[s].ModuleCode.startsWith(t)&&e.modList.push({ModuleCode:d[s].ModuleCode,ModuleTitle:d[s].ModuleTitle,Semesters:d[s].Semesters})}sessionStorage.setItem("oldText",t)}},e.getProfile=function(){function t(e){var t=parseInt(JSON.parse(sessionStorage.getItem("modsTaken"))[0].AcadYear.substring(5)),o=[],s=new Date,d=(s.getFullYear(),s.getMonth());e=parseInt(e);for(var r=1,a=e;t>=a;a++){var n=a+1;n==t?9>d?(n=a+"/"+n+"-"+r,o.push(n),n=a+1,n=a+"/"+n+"-"+(r+1),o.push(n)):(n=a+"/"+n+"-"+r,o.push(n),n=a+1,n=a+"/"+n+"-"+(r+1),o.push(n),n=a+2,n=a+1+"/"+n+"-"+r,o.push(n)):t>n&&(n=a+"/"+n+"-"+r,o.push(n),n=a+1,n=a+"/"+n+"-"+(r+1),o.push(n))}return o}l().then(function(o){console.log(o.data),e.username=o.data.Results[0].Name,sessionStorage.setItem("userName",e.username),sessionStorage.setItem("netid",o.data.Results[0].UserID),sessionStorage.setItem("firstMajor",o.data.Results[0].FirstMajor),sessionStorage.setItem("secondMajor",o.data.Results[0].SecondMajor),sessionStorage.setItem("matricYear",o.data.Results[0].MatriculationYear),e.plannerSize=[],e.unlockSem=[];for(var s=3,d=o.data.Results[0].MatriculationYear,r=0;s>r;r++)e.plannerSize.push({candidatureYear:parseInt(d)+r+"/"+(parseInt(d)+r+1),modsPerSem:5});e.addYear=function(){s+=1;var t={candidatureYear:parseInt(d)+s-1+"/"+(parseInt(d)+s),modsPerSem:5};e.plannerSize.push(t)},u(o.data.Results[0].UserID).then(function(o){e.modsCount=o.data.Results.length,sessionStorage.setItem("modsTaken",JSON.stringify(o.data.Results)),e.specialMods=[],e.modsPerSem=[];var s=JSON.parse(sessionStorage.getItem("modsTaken"));JSON.parse(sessionStorage.getItem("modsTaken")).length;sessionStorage.setItem("userSem",JSON.stringify(t(JSON.parse(sessionStorage.getItem("matricYear"))))),console.log("test result : "+t(JSON.parse(sessionStorage.getItem("matricYear"))));var d=JSON.parse(sessionStorage.getItem("userSem"));angular.forEach(d,function(t,o){e.takenMods=[];var r=[];e.unlockSem.push(!1),angular.forEach(s,function(t,a){s[a].Semester==d[o].substring(10,11)&&s[a].AcadYear==d[o].substring(0,9)&&m(s[a].ModuleCode,s[a].Semester,s[a].AcadYear).then(function(t){""===t.data?(r.unshift({ModuleCode:s[a].ModuleCode,ModuleTitle:s[a].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[a].AcadYear,Semester:s[a].Semester}),e.takenMods.push({ModuleCode:s[a].ModuleCode,ModuleTitle:s[a].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:["Exempted"],selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:["-"],AcadYear:s[a].AcadYear,Semester:s[a].Semester}),r[0].selectedModGrade=r[0].ModuleGrade[0],r[0].selectedModSuStatus=r[0].ModuleSuStatus[0],sessionStorage.setItem(s[a].ModuleCode,JSON.stringify({ModuleTitle:s[a].ModuleTitle,ModuleCredit:4,ModuleStatus:"Exempted",ModuleSuStatus:"Yes",selectedModSuStatus:null,selectedModGrade:null,ModuleGrade:"-",AcadYear:s[a].AcadYear,Semester:s[a].Semester}))):(g(t.data.ModuleCode,s[a].Semester,s[a].AcadYear),r.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[a].AcadYear,Semester:s[a].Semester}),e.takenMods.push({ModuleCode:t.data.ModuleCode,ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:["No","Yes","Exempted","Waived"],selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:["A+","A","A-","B+","B","B-","C+","C","D+","D","F"],AcadYear:s[a].AcadYear,Semester:s[a].Semester}),sessionStorage.setItem(t.data.ModuleCode,JSON.stringify({ModuleTitle:t.data.ModuleTitle,ModuleCredit:t.data.ModuleCredit,ModuleStatus:"Normal",ModuleSuStatus:"No",selectedModSuStatus:"No",selectedModGrade:null,ModuleGrade:"-",AcadYear:s[a].AcadYear,Semester:s[a].Semester})))})}),e.modsPerSem.push(r)})},function(e){console.log("error no mods found")})},function(t){console.log("Invalid User"),e.username="Invalid User"})},e.logout=function(){sessionStorage.clear(),e.$applyAsync(function(){e.showMenu=!1}),window.location="http://localhost:8888/dist"},e.checkToken=function(){var t={method:"GET",url:"index.php?id=checkToken&token="+token};o(t).then(function(t){if($result=t.data.Success,0==$result)s.path("/login");else{var o=$result;e.$applyAsync(function(){e.showMenu=!0}),sessionStorage.setItem("isValidToken",o),sessionStorage.setItem("token",token)}},function(e){console.log("Error")})},e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(o,s){o>=M?angular.isDefined(t.get("toggle"))?e.toggle=!!t.get("toggle"):e.toggle=!0:e.toggle=!1}),e.toggleSidebar=function(){e.toggle=!e.toggle,t.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}var token;null==sessionStorage.getItem("token")?(token=getUrlVars().token,sessionStorage.setItem("isValidToken",!1)):(token=sessionStorage.getItem("token"),sessionStorage.setItem("isValidToken",!0),history.replaceState({},null,"index.html"));var userName,studentId;angular.module("NUSAP").controller("MasterCtrl",["$scope","$cookieStore","$http","$location","$window","$q","$log","$timeout",MasterCtrl]);
